...
class _ConfigModelCopyWithImpl<$R> extends BaseCopyWith<ConfigModel, $R> implements ConfigModelCopyWith<$R> {
  ...
  @override $R call({String? name, List<String>? ignoreFields, List<EnumValues>? enumValues, List<AttributeModel>? attributes, List<AttributeModel>? customAttributes, List<AttributeModel>? dateTimeAttributes, List<AttributeModel>? sqlAttributes, List<AttributeModel>? referenceAttributes, bool? isEnum, bool? createRepository, bool? isPlural, bool? isSearchResponsePlural}) => $then(ConfigModel(name: name ?? $value.name, ignoreFields: ignoreFields ?? $value.ignoreFields, enumValues: enumValues ?? $value.enumValues, attributes: attributes ?? $value.attributes, customAttributes: customAttributes ?? $value.customAttributes, dateTimeAttributes: dateTimeAttributes ?? $value.dateTimeAttributes, sqlAttributes: sqlAttributes ?? $value.sqlAttributes, referenceAttributes: referenceAttributes ?? $value.referenceAttributes, isEnum: isEnum ?? $value.isEnum, createRepository: createRepository ?? $value.createRepository, isPlural: isPlural ?? $value.isPlural, isSearchResponsePlural: isSearchResponsePlural ?? $value.isSearchResponsePlural));
}
...
abstract class AttributeModelCopyWith<$R> {
  ...
  $R call({String? name, String? type, String? columnType, bool? isList, bool? isPk, bool? isEnum, bool? nullable, bool? includeForTable, bool? includeForQuery, bool? includeForEntity, bool? createReference, String? referencePkName, List<TableReferenceModel>? references});
...
class _AttributeModelCopyWithImpl<$R> extends BaseCopyWith<AttributeModel, $R> implements AttributeModelCopyWith<$R> {
  ...
  @override $R call({String? name, String? type, String? columnType, bool? isList, bool? isPk, bool? isEnum, bool? nullable, bool? includeForTable, bool? includeForQuery, bool? includeForEntity, bool? createReference, Object? referencePkName = $none, List<TableReferenceModel>? references}) => $then(AttributeModel(name: name ?? $value.name, type: type ?? $value.type, columnType: columnType ?? $value.columnType, isList: isList ?? $value.isList, isPk: isPk ?? $value.isPk, isEnum: isEnum ?? $value.isEnum, nullable: nullable ?? $value.nullable, includeForTable: includeForTable ?? $value.includeForTable, includeForQuery: includeForQuery ?? $value.includeForQuery, includeForEntity: includeForEntity ?? $value.includeForEntity, createReference: createReference ?? $value.createReference, referencePkName: or(referencePkName, $value.referencePkName), references: references ?? $value.references));
}
