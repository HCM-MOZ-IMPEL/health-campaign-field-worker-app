...
abstract class AddressModelCopyWith<$R> {
  ...
  $R call({AddressAdditionalFields? additionalFields, String? id, String? relatedClientReferenceId, String? doorNo, double? latitude, double? longitude, double? locationAccuracy, String? addressLine1, String? addressLine2, String? landmark, String? city, String? pincode, String? buildingName, String? street, String? boundaryType, String? boundary, String? tenantId, int? rowVersion, AddressType? type, LocalityModel? locality, AuditDetails? auditDetails, bool? isDeleted});
...
class _AddressModelCopyWithImpl<$R> extends BaseCopyWith<AddressModel, $R> implements AddressModelCopyWith<$R> {
  ...
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? relatedClientReferenceId = $none, Object? doorNo = $none, Object? latitude = $none, Object? longitude = $none, Object? locationAccuracy = $none, Object? addressLine1 = $none, Object? addressLine2 = $none, Object? landmark = $none, Object? city = $none, Object? pincode = $none, Object? buildingName = $none, Object? street = $none, Object? boundaryType = $none, Object? boundary = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? type = $none, Object? locality = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(AddressModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), relatedClientReferenceId: or(relatedClientReferenceId, $value.relatedClientReferenceId), doorNo: or(doorNo, $value.doorNo), latitude: or(latitude, $value.latitude), longitude: or(longitude, $value.longitude), locationAccuracy: or(locationAccuracy, $value.locationAccuracy), addressLine1: or(addressLine1, $value.addressLine1), addressLine2: or(addressLine2, $value.addressLine2), landmark: or(landmark, $value.landmark), city: or(city, $value.city), pincode: or(pincode, $value.pincode), buildingName: or(buildingName, $value.buildingName), street: or(street, $value.street), boundaryType: or(boundaryType, $value.boundaryType), boundary: or(boundary, $value.boundary), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), type: or(type, $value.type), locality: or(locality, $value.locality), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class AttributesModelMapper extends BaseMapper<AttributesModel> {
  ...
  AttributesModel fromMap(Map<String, dynamic> map) => AttributesModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), dataType: Mapper.i.$getOpt(map, 'dataType'), referenceId: Mapper.i.$getOpt(map, 'referenceId'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), code: Mapper.i.$getOpt(map, 'code'), values: Mapper.i.$getOpt(map, 'values'), isActive: Mapper.i.$getOpt(map, 'isActive'), required: Mapper.i.$getOpt(map, 'required'), regex: Mapper.i.$getOpt(map, 'regex'), order: Mapper.i.$getOpt(map, 'order'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class AttributesModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({AttributesAdditionalFields? additionalFields, String? id, String? dataType, String? referenceId, String? tenantId, String? code, List<String>? values, String? isActive, bool? required, String? regex, int? order, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _AttributesModelCopyWithImpl<$R> extends BaseCopyWith<AttributesModel, $R> implements AttributesModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? dataType = $none, Object? referenceId = $none, Object? tenantId = $none, Object? code = $none, Object? values = $none, Object? isActive = $none, Object? required = $none, Object? regex = $none, Object? order = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(AttributesModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), dataType: or(dataType, $value.dataType), referenceId: or(referenceId, $value.referenceId), tenantId: or(tenantId, $value.tenantId), code: or(code, $value.code), values: or(values, $value.values), isActive: or(isActive, $value.isActive), required: or(required, $value.required), regex: or(regex, $value.regex), order: or(order, $value.order), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class DocumentModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({DocumentAdditionalFields? additionalFields, String? id, String? documentType, String? fileStoreId, String? documentUid, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
abstract class FacilityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({FacilityAdditionalFields? additionalFields, String? id, String? name, bool? isPermanent, String? usage, int? storageCapacity, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, bool? isDeleted});
...
abstract class HouseholdModelCopyWith<$R> {
  ...
  AddressModelCopyWith<$R>? get address;
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({HouseholdAdditionalFields? additionalFields, String? id, int? memberCount, String? clientReferenceId, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, bool? isDeleted});
...
class _HouseholdModelCopyWithImpl<$R> extends BaseCopyWith<HouseholdModel, $R> implements HouseholdModelCopyWith<$R> {
  ...
  @override AddressModelCopyWith<$R>? get address => $value.address != null ? AddressModelCopyWith($value.address!, (v) => call(address: v)) : null;
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? memberCount = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? address = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(HouseholdModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), memberCount: or(memberCount, $value.memberCount), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), address: or(address, $value.address), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class HouseholdMemberModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({HouseholdMemberAdditionalFields? additionalFields, String? id, String? householdId, String? householdClientReferenceId, String? individualId, String? individualClientReferenceId, bool? isHeadOfHousehold, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _HouseholdMemberModelCopyWithImpl<$R> extends BaseCopyWith<HouseholdMemberModel, $R> implements HouseholdMemberModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? householdId = $none, Object? householdClientReferenceId = $none, Object? individualId = $none, Object? individualClientReferenceId = $none, bool? isHeadOfHousehold, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(HouseholdMemberModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), householdId: or(householdId, $value.householdId), householdClientReferenceId: or(householdClientReferenceId, $value.householdClientReferenceId), individualId: or(individualId, $value.individualId), individualClientReferenceId: or(individualClientReferenceId, $value.individualClientReferenceId), isHeadOfHousehold: isHeadOfHousehold ?? $value.isHeadOfHousehold, clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class IdentifierModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({IdentifierAdditionalFields? additionalFields, String? id, String? identifierType, String? identifierId, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _IdentifierModelCopyWithImpl<$R> extends BaseCopyWith<IdentifierModel, $R> implements IdentifierModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? identifierType = $none, Object? identifierId = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(IdentifierModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), identifierType: or(identifierType, $value.identifierType), identifierId: or(identifierId, $value.identifierId), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class LocalityModelMapper extends BaseMapper<LocalityModel> {
  ...
  LocalityModel fromMap(Map<String, dynamic> map) => LocalityModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), code: Mapper.i.$get(map, 'code'), name: Mapper.i.$getOpt(map, 'name'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class LocalityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({LocalityAdditionalFields? additionalFields, String? code, String? name, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _LocalityModelCopyWithImpl<$R> extends BaseCopyWith<LocalityModel, $R> implements LocalityModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? code, Object? name = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(LocalityModel(additionalFields: or(additionalFields, $value.additionalFields), code: code ?? $value.code, name: or(name, $value.name), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class NameModelMapper extends BaseMapper<NameModel> {
  ...
  NameModel fromMap(Map<String, dynamic> map) => NameModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), individualClientReferenceId: Mapper.i.$getOpt(map, 'individualClientReferenceId'), givenName: Mapper.i.$getOpt(map, 'givenName'), familyName: Mapper.i.$getOpt(map, 'familyName'), otherNames: Mapper.i.$getOpt(map, 'otherNames'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class NameModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({NameAdditionalFields? additionalFields, String? id, String? individualClientReferenceId, String? givenName, String? familyName, String? otherNames, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _NameModelCopyWithImpl<$R> extends BaseCopyWith<NameModel, $R> implements NameModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? individualClientReferenceId = $none, Object? givenName = $none, Object? familyName = $none, Object? otherNames = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(NameModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), individualClientReferenceId: or(individualClientReferenceId, $value.individualClientReferenceId), givenName: or(givenName, $value.givenName), familyName: or(familyName, $value.familyName), otherNames: or(otherNames, $value.otherNames), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class ProductModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProductAdditionalFields? additionalFields, String? id, String? type, String? name, String? manufacturer, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _ProductModelCopyWithImpl<$R> extends BaseCopyWith<ProductModel, $R> implements ProductModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? type = $none, Object? name = $none, Object? manufacturer = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(ProductModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), type: or(type, $value.type), name: or(name, $value.name), manufacturer: or(manufacturer, $value.manufacturer), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProductVariantModelMapper extends BaseMapper<ProductVariantModel> {
  ...
  ProductVariantModel fromMap(Map<String, dynamic> map) => ProductVariantModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), productId: Mapper.i.$getOpt(map, 'productId'), sku: Mapper.i.$getOpt(map, 'sku'), variation: Mapper.i.$getOpt(map, 'variation'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class ProductVariantModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProductVariantAdditionalFields? additionalFields, String? id, String? productId, String? sku, String? variation, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _ProductVariantModelCopyWithImpl<$R> extends BaseCopyWith<ProductVariantModel, $R> implements ProductVariantModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? id, Object? productId = $none, Object? sku = $none, Object? variation = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(ProductVariantModel(additionalFields: or(additionalFields, $value.additionalFields), id: id ?? $value.id, productId: or(productId, $value.productId), sku: or(sku, $value.sku), variation: or(variation, $value.variation), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class ProjectBeneficiaryModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectBeneficiaryAdditionalFields? additionalFields, String? id, String? projectId, String? beneficiaryId, String? beneficiaryClientReferenceId, String? clientReferenceId, String? tenantId, int? rowVersion, int? dateOfRegistration, AuditDetails? auditDetails, bool? isDeleted});
...
class ProjectFacilityModelMapper extends BaseMapper<ProjectFacilityModel> {
  ...
  ProjectFacilityModel fromMap(Map<String, dynamic> map) => ProjectFacilityModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), facilityId: Mapper.i.$get(map, 'facilityId'), projectId: Mapper.i.$get(map, 'projectId'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class ProjectFacilityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectFacilityAdditionalFields? additionalFields, String? id, String? facilityId, String? projectId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _ProjectFacilityModelCopyWithImpl<$R> extends BaseCopyWith<ProjectFacilityModel, $R> implements ProjectFacilityModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? id, String? facilityId, String? projectId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(ProjectFacilityModel(additionalFields: or(additionalFields, $value.additionalFields), id: id ?? $value.id, facilityId: facilityId ?? $value.facilityId, projectId: projectId ?? $value.projectId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProjectProductVariantModelMapper extends BaseMapper<ProjectProductVariantModel> {
  ...
  ProjectProductVariantModel fromMap(Map<String, dynamic> map) => ProjectProductVariantModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), productVariantId: Mapper.i.$get(map, 'productVariantId'), type: Mapper.i.$getOpt(map, 'type'), isBaseUnitVariant: Mapper.i.$getOpt(map, 'isBaseUnitVariant'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class ProjectProductVariantModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectProductVariantAdditionalFields? additionalFields, String? productVariantId, String? type, bool? isBaseUnitVariant, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _ProjectProductVariantModelCopyWithImpl<$R> extends BaseCopyWith<ProjectProductVariantModel, $R> implements ProjectProductVariantModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? productVariantId, Object? type = $none, Object? isBaseUnitVariant = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(ProjectProductVariantModel(additionalFields: or(additionalFields, $value.additionalFields), productVariantId: productVariantId ?? $value.productVariantId, type: or(type, $value.type), isBaseUnitVariant: or(isBaseUnitVariant, $value.isBaseUnitVariant), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProjectResourceModelMapper extends BaseMapper<ProjectResourceModel> {
  ...
  ProjectResourceModel fromMap(Map<String, dynamic> map) => ProjectResourceModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), projectId: Mapper.i.$getOpt(map, 'projectId'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), resource: Mapper.i.$get(map, 'resource'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class ProjectResourceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectResourceAdditionalFields? additionalFields, String? id, String? projectId, String? tenantId, int? rowVersion, ProjectProductVariantModel? resource, AuditDetails? auditDetails, bool? isDeleted});
...
class _ProjectResourceModelCopyWithImpl<$R> extends BaseCopyWith<ProjectResourceModel, $R> implements ProjectResourceModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? projectId = $none, Object? tenantId = $none, Object? rowVersion = $none, ProjectProductVariantModel? resource, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(ProjectResourceModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), projectId: or(projectId, $value.projectId), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), resource: resource ?? $value.resource, auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProjectStaffModelMapper extends BaseMapper<ProjectStaffModel> {
  ...
  ProjectStaffModel fromMap(Map<String, dynamic> map) => ProjectStaffModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), staffId: Mapper.i.$getOpt(map, 'staffId'), userId: Mapper.i.$getOpt(map, 'userId'), projectId: Mapper.i.$getOpt(map, 'projectId'), channel: Mapper.i.$getOpt(map, 'channel'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), startDate: Mapper.i.$getOpt(map, 'startDate'), endDate: Mapper.i.$getOpt(map, 'endDate'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class ProjectStaffModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectStaffAdditionalFields? additionalFields, String? id, String? staffId, String? userId, String? projectId, String? channel, String? tenantId, int? rowVersion, int? startDate, int? endDate, AuditDetails? auditDetails, bool? isDeleted});
...
abstract class ServiceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ServiceAdditionalFields? additionalFields, String? id, String? clientId, String? serviceDefId, bool? isActive, String? accountId, String? additionalDetails, String? createdAt, String? tenantId, int? rowVersion, List<ServiceAttributesModel>? attributes, AuditDetails? auditDetails, bool? isDeleted});
...
abstract class ServiceAttributesModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ServiceAttributesAdditionalFields? additionalFields, String? attributeCode, dynamic value, String? dataType, String? referenceId, dynamic additionalDetails, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class ServiceDefinitionModelMapper extends BaseMapper<ServiceDefinitionModel> {
  ...
  ServiceDefinitionModel fromMap(Map<String, dynamic> map) => ServiceDefinitionModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), code: Mapper.i.$getOpt(map, 'code'), isActive: Mapper.i.$getOpt(map, 'isActive'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), attributes: Mapper.i.$getOpt(map, 'attributes'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class ServiceDefinitionModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ServiceDefinitionAdditionalFields? additionalFields, String? id, String? tenantId, String? code, bool? isActive, int? rowVersion, List<AttributesModel>? attributes, AuditDetails? auditDetails, bool? isDeleted});
...
class _ServiceDefinitionModelCopyWithImpl<$R> extends BaseCopyWith<ServiceDefinitionModel, $R> implements ServiceDefinitionModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? tenantId = $none, Object? code = $none, Object? isActive = $none, Object? rowVersion = $none, Object? attributes = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(ServiceDefinitionModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), tenantId: or(tenantId, $value.tenantId), code: or(code, $value.code), isActive: or(isActive, $value.isActive), rowVersion: or(rowVersion, $value.rowVersion), attributes: or(attributes, $value.attributes), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class _TaskModelCopyWithImpl<$R> extends BaseCopyWith<TaskModel, $R> implements TaskModelCopyWith<$R> {
  ...
  @override AddressModelCopyWith<$R>? get address => $value.address != null ? AddressModelCopyWith($value.address!, (v) => call(address: v)) : null;
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? projectId = $none, Object? projectBeneficiaryId = $none, Object? projectBeneficiaryClientReferenceId = $none, Object? createdBy = $none, Object? status = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? resources = $none, Object? address = $none, Object? plannedStartDate = $none, Object? plannedEndDate = $none, Object? actualStartDate = $none, Object? actualEndDate = $none, Object? createdDate = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(TaskModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), projectId: or(projectId, $value.projectId), projectBeneficiaryId: or(projectBeneficiaryId, $value.projectBeneficiaryId), projectBeneficiaryClientReferenceId: or(projectBeneficiaryClientReferenceId, $value.projectBeneficiaryClientReferenceId), createdBy: or(createdBy, $value.createdBy), status: or(status, $value.status), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), resources: or(resources, $value.resources), address: or(address, $value.address), plannedStartDate: or(plannedStartDate, $value.plannedStartDate), plannedEndDate: or(plannedEndDate, $value.plannedEndDate), actualStartDate: or(actualStartDate, $value.actualStartDate), actualEndDate: or(actualEndDate, $value.actualEndDate), createdDate: or(createdDate, $value.createdDate), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class TaskResourceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({TaskResourceAdditionalFields? additionalFields, String? clientReferenceId, String? taskId, String? id, String? productVariantId, String? quantity, bool? isDelivered, String? deliveryComment, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
class _TaskResourceModelCopyWithImpl<$R> extends BaseCopyWith<TaskResourceModel, $R> implements TaskResourceModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? clientReferenceId, Object? taskId = $none, Object? id = $none, Object? productVariantId = $none, Object? quantity = $none, Object? isDelivered = $none, Object? deliveryComment = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(TaskResourceModel(additionalFields: or(additionalFields, $value.additionalFields), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, taskId: or(taskId, $value.taskId), id: or(id, $value.id), productVariantId: or(productVariantId, $value.productVariantId), quantity: or(quantity, $value.quantity), isDelivered: or(isDelivered, $value.isDelivered), deliveryComment: or(deliveryComment, $value.deliveryComment), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class OpLogEntryCopyWith<$R, T extends EntityModel> {
  ...
  $R call({T? entity, DataOperation? operation, int? id, DateTime? createdAt, String? createdBy, DataModelType? type, bool? syncedUp, bool? syncedDown, DateTime? syncedUpOn, DateTime? syncedDownOn, String? serverGeneratedId, String? clientReferenceId, List<AdditionalId>? additionalIds, int? syncDownRetryCount, int? rowVersion});
...
class _OpLogEntryCopyWithImpl<$R, T extends EntityModel> extends BaseCopyWith<OpLogEntry<T>, $R> implements OpLogEntryCopyWith<$R, T> {
  ...
  @override $R call({T? entity, DataOperation? operation, Object? id = $none, DateTime? createdAt, String? createdBy, DataModelType? type, bool? syncedUp, bool? syncedDown, Object? syncedUpOn = $none, Object? syncedDownOn = $none, Object? serverGeneratedId = $none, Object? clientReferenceId = $none, List<AdditionalId>? additionalIds, int? syncDownRetryCount, int? rowVersion}) => $then(OpLogEntry(entity ?? $value.entity, operation ?? $value.operation, id: or(id, $value.id), createdAt: createdAt ?? $value.createdAt, createdBy: createdBy ?? $value.createdBy, type: type ?? $value.type, syncedUp: syncedUp ?? $value.syncedUp, syncedDown: syncedDown ?? $value.syncedDown, syncedUpOn: or(syncedUpOn, $value.syncedUpOn), syncedDownOn: or(syncedDownOn, $value.syncedDownOn), serverGeneratedId: or(serverGeneratedId, $value.serverGeneratedId), clientReferenceId: or(clientReferenceId, $value.clientReferenceId), additionalIds: additionalIds ?? $value.additionalIds, syncDownRetryCount: syncDownRetryCount ?? $value.syncDownRetryCount, rowVersion: rowVersion ?? $value.rowVersion));
}
