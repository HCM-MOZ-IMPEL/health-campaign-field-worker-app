...
class BoundaryModelMapper extends BaseMapper<BoundaryModel> {
  ...
  BoundaryModel fromMap(Map<String, dynamic> map) => BoundaryModel(code: Mapper.i.$getOpt(map, 'code'), name: Mapper.i.$getOpt(map, 'name'), label: Mapper.i.$getOpt(map, 'label'), latitude: Mapper.i.$getOpt(map, 'latitude'), longitude: Mapper.i.$getOpt(map, 'longitude'), materializedPath: Mapper.i.$getOpt(map, 'materializedPath'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'));

  @override Function get encoder => (BoundaryModel v) => encode(v);
  dynamic encode(BoundaryModel v) => toMap(v);
  Map<String, dynamic> toMap(BoundaryModel b) => {if (Mapper.i.$enc(b.code, 'code') != null) 'code': Mapper.i.$enc(b.code, 'code'), if (Mapper.i.$enc(b.name, 'name') != null) 'name': Mapper.i.$enc(b.name, 'name'), if (Mapper.i.$enc(b.label, 'label') != null) 'label': Mapper.i.$enc(b.label, 'label'), if (Mapper.i.$enc(b.latitude, 'latitude') != null) 'latitude': Mapper.i.$enc(b.latitude, 'latitude'), if (Mapper.i.$enc(b.longitude, 'longitude') != null) 'longitude': Mapper.i.$enc(b.longitude, 'longitude'), if (Mapper.i.$enc(b.materializedPath, 'materializedPath') != null) 'materializedPath': Mapper.i.$enc(b.materializedPath, 'materializedPath'), if (Mapper.i.$enc(b.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(b.tenantId, 'tenantId'), if (Mapper.i.$enc(b.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(b.isDeleted, 'isDeleted'), if (Mapper.i.$enc(b.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(b.rowVersion, 'rowVersion'), if (Mapper.i.$enc(b.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(b.auditDetails, 'auditDetails')};

  @override String stringify(BoundaryModel self) => 'BoundaryModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, auditDetails: ${Mapper.asString(self.auditDetails)}, code: ${Mapper.asString(self.code)}, name: ${Mapper.asString(self.name)}, label: ${Mapper.asString(self.label)}, latitude: ${Mapper.asString(self.latitude)}, longitude: ${Mapper.asString(self.longitude)}, materializedPath: ${Mapper.asString(self.materializedPath)}, tenantId: ${Mapper.asString(self.tenantId)}, isDeleted: ${Mapper.asString(self.isDeleted)}, rowVersion: ${Mapper.asString(self.rowVersion)})';
  @override int hash(BoundaryModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.code) ^ Mapper.hash(self.name) ^ Mapper.hash(self.label) ^ Mapper.hash(self.latitude) ^ Mapper.hash(self.longitude) ^ Mapper.hash(self.materializedPath) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion);
  @override bool equals(BoundaryModel self, BoundaryModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.label, other.label) && Mapper.isEqual(self.latitude, other.latitude) && Mapper.isEqual(self.longitude, other.longitude) && Mapper.isEqual(self.materializedPath, other.materializedPath) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion);
...
abstract class BoundaryModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({String? code, String? name, String? label, String? latitude, String? longitude, String? materializedPath, String? tenantId, bool? isDeleted, int? rowVersion, AuditDetails? auditDetails});
...
class _BoundaryModelCopyWithImpl<$R> extends BaseCopyWith<BoundaryModel, $R> implements BoundaryModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? code = $none, Object? name = $none, Object? label = $none, Object? latitude = $none, Object? longitude = $none, Object? materializedPath = $none, Object? tenantId = $none, Object? isDeleted = $none, Object? rowVersion = $none, Object? auditDetails = $none}) => $then(BoundaryModel(code: or(code, $value.code), name: or(name, $value.name), label: or(label, $value.label), latitude: or(latitude, $value.latitude), longitude: or(longitude, $value.longitude), materializedPath: or(materializedPath, $value.materializedPath), tenantId: or(tenantId, $value.tenantId), isDeleted: or(isDeleted, $value.isDeleted), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails)));
}
...
class FacilitySearchModelMapper extends BaseMapper<FacilitySearchModel> {
  ...
  FacilitySearchModel fromMap(Map<String, dynamic> map) => FacilitySearchModel(id: Mapper.i.$getOpt(map, 'id'), isPermanent: Mapper.i.$getOpt(map, 'isPermanent'), usage: Mapper.i.$getOpt(map, 'usage'), storageCapacity: Mapper.i.$getOpt(map, 'storageCapacity'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted'), boundaryCode: Mapper.i.$getOpt(map, 'boundaryCode'));
  ...
  @override int hash(FacilitySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.isPermanent) ^ Mapper.hash(self.usage) ^ Mapper.hash(self.storageCapacity) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(FacilitySearchModel self, FacilitySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.isPermanent, other.isPermanent) && Mapper.isEqual(self.usage, other.usage) && Mapper.isEqual(self.storageCapacity, other.storageCapacity) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
abstract class FacilitySearchModelCopyWith<$R> {
  ...
  $R call({List<String>? id, bool? isPermanent, String? usage, int? storageCapacity, String? tenantId, bool? isDeleted, String? boundaryCode});
...
class _FacilitySearchModelCopyWithImpl<$R> extends BaseCopyWith<FacilitySearchModel, $R> implements FacilitySearchModelCopyWith<$R> {
  ...
  @override $R call({Object? id = $none, Object? isPermanent = $none, Object? usage = $none, Object? storageCapacity = $none, Object? tenantId = $none, Object? isDeleted = $none, Object? boundaryCode = $none}) => $then(FacilitySearchModel(id: or(id, $value.id), isPermanent: or(isPermanent, $value.isPermanent), usage: or(usage, $value.usage), storageCapacity: or(storageCapacity, $value.storageCapacity), tenantId: or(tenantId, $value.tenantId), isDeleted: or(isDeleted, $value.isDeleted), boundaryCode: or(boundaryCode, $value.boundaryCode)));
}
...
class FacilityModelMapper extends BaseMapper<FacilityModel> {
  ...
  FacilityModel fromMap(Map<String, dynamic> map) => FacilityModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), isPermanent: Mapper.i.$getOpt(map, 'isPermanent'), usage: Mapper.i.$getOpt(map, 'usage'), storageCapacity: Mapper.i.$getOpt(map, 'storageCapacity'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), address: Mapper.i.$getOpt(map, 'address'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'));
...
abstract class FacilityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({FacilityAdditionalFields? additionalFields, String? id, bool? isPermanent, String? usage, int? storageCapacity, String? tenantId, bool? isDeleted, int? rowVersion, AddressModel? address, AuditDetails? auditDetails});
