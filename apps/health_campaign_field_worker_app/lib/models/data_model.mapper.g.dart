...
abstract class OpLogEntryCopyWith<$R, T extends EntityModel> {
  ...
  $R call({T? entity, DataOperation? operation, int? id, DateTime? createdAt, String? createdBy, DataModelType? type, bool? syncedUp, bool? syncedDown, DateTime? syncedUpOn, DateTime? syncedDownOn, String? serverGeneratedId, String? clientReferenceId, List<AdditionalId>? additionalIds, int? syncDownRetryCount});
...
class _OpLogEntryCopyWithImpl<$R, T extends EntityModel> extends BaseCopyWith<OpLogEntry<T>, $R> implements OpLogEntryCopyWith<$R, T> {
  ...
  @override $R call({T? entity, DataOperation? operation, Object? id = $none, DateTime? createdAt, String? createdBy, DataModelType? type, bool? syncedUp, bool? syncedDown, Object? syncedUpOn = $none, Object? syncedDownOn = $none, Object? serverGeneratedId = $none, Object? clientReferenceId = $none, List<AdditionalId>? additionalIds, int? syncDownRetryCount}) => $then(OpLogEntry(entity ?? $value.entity, operation ?? $value.operation, id: or(id, $value.id), createdAt: createdAt ?? $value.createdAt, createdBy: createdBy ?? $value.createdBy, type: type ?? $value.type, syncedUp: syncedUp ?? $value.syncedUp, syncedDown: syncedDown ?? $value.syncedDown, syncedUpOn: or(syncedUpOn, $value.syncedUpOn), syncedDownOn: or(syncedDownOn, $value.syncedDownOn), serverGeneratedId: or(serverGeneratedId, $value.serverGeneratedId), clientReferenceId: or(clientReferenceId, $value.clientReferenceId), additionalIds: additionalIds ?? $value.additionalIds, syncDownRetryCount: syncDownRetryCount ?? $value.syncDownRetryCount));
}
