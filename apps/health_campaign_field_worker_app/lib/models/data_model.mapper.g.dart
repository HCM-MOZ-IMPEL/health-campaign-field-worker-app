...
class EntitySearchModelMapper extends BaseMapper<EntitySearchModel> {
  ...
  Map<String, dynamic> toMap(EntitySearchModel e) => {if (Mapper.i.$enc(e.boundaryCode, 'boundaryCode') != null) 'boundaryCode': Mapper.i.$enc(e.boundaryCode, 'boundaryCode'), if (Mapper.i.$enc(e.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(e.auditDetails, 'auditDetails'), if (Mapper.i.$enc(e.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(e.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(e.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(e.additionalFields, 'additionalFields')};

  @override String stringify(EntitySearchModel self) => 'EntitySearchModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, auditDetails: ${Mapper.asString(self.auditDetails)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(EntitySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields);
  @override bool equals(EntitySearchModel self, EntitySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class AddressSearchModelMapper extends BaseMapper<AddressSearchModel> {
  ...
  @override int hash(AddressSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId);
  @override bool equals(AddressSearchModel self, AddressSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId);
...
abstract class AddressModelCopyWith<$R> {
  ...
  $R call({AddressAdditionalFields? additionalFields, String? id, String? relatedClientReferenceId, String? doorNo, double? latitude, double? longitude, double? locationAccuracy, String? addressLine1, String? addressLine2, String? landmark, String? city, String? pincode, String? buildingName, String? street, String? boundaryType, String? boundary, String? tenantId, int? rowVersion, AddressType? type, LocalityModel? locality, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class AttributesSearchModelMapper extends BaseMapper<AttributesSearchModel> {
  ...
  @override int hash(AttributesSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.dataType) ^ Mapper.hash(self.referenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.required) ^ Mapper.hash(self.regex) ^ Mapper.hash(self.order);
  @override bool equals(AttributesSearchModel self, AttributesSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.dataType, other.dataType) && Mapper.isEqual(self.referenceId, other.referenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.required, other.required) && Mapper.isEqual(self.regex, other.regex) && Mapper.isEqual(self.order, other.order);
...
class AttributesModelMapper extends BaseMapper<AttributesModel> {
  ...
  Map<String, dynamic> toMap(AttributesModel a) => {if (Mapper.i.$enc(a.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(a.additionalFields, 'additionalFields'), if (Mapper.i.$enc(a.id, 'id') != null) 'id': Mapper.i.$enc(a.id, 'id'), if (Mapper.i.$enc(a.dataType, 'dataType') != null) 'dataType': Mapper.i.$enc(a.dataType, 'dataType'), if (Mapper.i.$enc(a.referenceId, 'referenceId') != null) 'referenceId': Mapper.i.$enc(a.referenceId, 'referenceId'), if (Mapper.i.$enc(a.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(a.tenantId, 'tenantId'), if (Mapper.i.$enc(a.code, 'code') != null) 'code': Mapper.i.$enc(a.code, 'code'), if (Mapper.i.$enc(a.values, 'values') != null) 'values': Mapper.i.$enc(a.values, 'values'), if (Mapper.i.$enc(a.isActive, 'isActive') != null) 'isActive': Mapper.i.$enc(a.isActive, 'isActive'), if (Mapper.i.$enc(a.required, 'required') != null) 'required': Mapper.i.$enc(a.required, 'required'), if (Mapper.i.$enc(a.regex, 'regex') != null) 'regex': Mapper.i.$enc(a.regex, 'regex'), if (Mapper.i.$enc(a.order, 'order') != null) 'order': Mapper.i.$enc(a.order, 'order'), if (Mapper.i.$enc(a.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(a.rowVersion, 'rowVersion'), if (Mapper.i.$enc(a.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(a.auditDetails, 'auditDetails'), if (Mapper.i.$enc(a.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(a.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(a.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(a.isDeleted, 'isDeleted')};

  @override String stringify(AttributesModel self) => 'AttributesModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, dataType: ${Mapper.asString(self.dataType)}, referenceId: ${Mapper.asString(self.referenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, code: ${Mapper.asString(self.code)}, values: ${Mapper.asString(self.values)}, isActive: ${Mapper.asString(self.isActive)}, required: ${Mapper.asString(self.required)}, regex: ${Mapper.asString(self.regex)}, order: ${Mapper.asString(self.order)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(AttributesModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.dataType) ^ Mapper.hash(self.referenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.values) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.required) ^ Mapper.hash(self.regex) ^ Mapper.hash(self.order) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(AttributesModel self, AttributesModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.dataType, other.dataType) && Mapper.isEqual(self.referenceId, other.referenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.values, other.values) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.required, other.required) && Mapper.isEqual(self.regex, other.regex) && Mapper.isEqual(self.order, other.order) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class AttributesModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({AttributesAdditionalFields? additionalFields, String? id, String? dataType, String? referenceId, String? tenantId, String? code, List<String>? values, String? isActive, bool? required, String? regex, int? order, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class _AttributesModelCopyWithImpl<$R> extends BaseCopyWith<AttributesModel, $R> implements AttributesModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override ClientAuditDetailsCopyWith<$R>? get clientAuditDetails => $value.clientAuditDetails != null ? ClientAuditDetailsCopyWith($value.clientAuditDetails!, (v) => call(clientAuditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? dataType = $none, Object? referenceId = $none, Object? tenantId = $none, Object? code = $none, Object? values = $none, Object? isActive = $none, Object? required = $none, Object? regex = $none, Object? order = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? clientAuditDetails = $none, Object? isDeleted = $none}) => $then(AttributesModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), dataType: or(dataType, $value.dataType), referenceId: or(referenceId, $value.referenceId), tenantId: or(tenantId, $value.tenantId), code: or(code, $value.code), values: or(values, $value.values), isActive: or(isActive, $value.isActive), required: or(required, $value.required), regex: or(regex, $value.regex), order: or(order, $value.order), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: or(clientAuditDetails, $value.clientAuditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class BoundarySearchModelMapper extends BaseMapper<BoundarySearchModel> {
  ...
  @override int hash(BoundarySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.boundaryType) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.code);
  @override bool equals(BoundarySearchModel self, BoundarySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.boundaryType, other.boundaryType) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.code, other.code);
...
class DocumentSearchModelMapper extends BaseMapper<DocumentSearchModel> {
  ...
  @override int hash(DocumentSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId);
  @override bool equals(DocumentSearchModel self, DocumentSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class DocumentModelMapper extends BaseMapper<DocumentModel> {
  ...
  Map<String, dynamic> toMap(DocumentModel d) => {if (Mapper.i.$enc(d.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(d.additionalFields, 'additionalFields'), if (Mapper.i.$enc(d.id, 'id') != null) 'id': Mapper.i.$enc(d.id, 'id'), if (Mapper.i.$enc(d.documentType, 'documentType') != null) 'documentType': Mapper.i.$enc(d.documentType, 'documentType'), if (Mapper.i.$enc(d.fileStoreId, 'fileStoreId') != null) 'fileStoreId': Mapper.i.$enc(d.fileStoreId, 'fileStoreId'), if (Mapper.i.$enc(d.documentUid, 'documentUid') != null) 'documentUid': Mapper.i.$enc(d.documentUid, 'documentUid'), 'clientReferenceId': Mapper.i.$enc(d.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(d.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(d.tenantId, 'tenantId'), if (Mapper.i.$enc(d.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(d.rowVersion, 'rowVersion'), if (Mapper.i.$enc(d.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(d.auditDetails, 'auditDetails'), if (Mapper.i.$enc(d.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(d.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(d.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(d.isDeleted, 'isDeleted')};

  @override String stringify(DocumentModel self) => 'DocumentModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, documentType: ${Mapper.asString(self.documentType)}, fileStoreId: ${Mapper.asString(self.fileStoreId)}, documentUid: ${Mapper.asString(self.documentUid)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(DocumentModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.documentType) ^ Mapper.hash(self.fileStoreId) ^ Mapper.hash(self.documentUid) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(DocumentModel self, DocumentModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.documentType, other.documentType) && Mapper.isEqual(self.fileStoreId, other.fileStoreId) && Mapper.isEqual(self.documentUid, other.documentUid) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class DocumentModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({DocumentAdditionalFields? additionalFields, String? id, String? documentType, String? fileStoreId, String? documentUid, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class FacilitySearchModelMapper extends BaseMapper<FacilitySearchModel> {
  ...
  @override int hash(FacilitySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.name) ^ Mapper.hash(self.isPermanent) ^ Mapper.hash(self.usage) ^ Mapper.hash(self.storageCapacity) ^ Mapper.hash(self.tenantId);
  @override bool equals(FacilitySearchModel self, FacilitySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.isPermanent, other.isPermanent) && Mapper.isEqual(self.usage, other.usage) && Mapper.isEqual(self.storageCapacity, other.storageCapacity) && Mapper.isEqual(self.tenantId, other.tenantId);
...
abstract class FacilityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({FacilityAdditionalFields? additionalFields, String? id, String? name, bool? isPermanent, String? usage, int? storageCapacity, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class HouseholdSearchModelMapper extends BaseMapper<HouseholdSearchModel> {
  ...
  @override int hash(HouseholdSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.memberCount) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId);
  @override bool equals(HouseholdSearchModel self, HouseholdSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.memberCount, other.memberCount) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class HouseholdModelMapper extends BaseMapper<HouseholdModel> {
  ...
  @override String stringify(HouseholdModel self) => 'HouseholdModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, memberCount: ${Mapper.asString(self.memberCount)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, address: ${Mapper.asString(self.address)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(HouseholdModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.memberCount) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.address) ^ Mapper.hash(self.additionalFields);
  @override bool equals(HouseholdModel self, HouseholdModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.memberCount, other.memberCount) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.address, other.address) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class HouseholdModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({HouseholdAdditionalFields? additionalFields, String? id, int? memberCount, String? clientReferenceId, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class _HouseholdMemberModelCopyWithImpl<$R> extends BaseCopyWith<HouseholdMemberModel, $R> implements HouseholdMemberModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override ClientAuditDetailsCopyWith<$R>? get clientAuditDetails => $value.clientAuditDetails != null ? ClientAuditDetailsCopyWith($value.clientAuditDetails!, (v) => call(clientAuditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? householdId = $none, Object? householdClientReferenceId = $none, Object? individualId = $none, Object? individualClientReferenceId = $none, bool? isHeadOfHousehold, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? clientAuditDetails = $none, Object? isDeleted = $none}) => $then(HouseholdMemberModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), householdId: or(householdId, $value.householdId), householdClientReferenceId: or(householdClientReferenceId, $value.householdClientReferenceId), individualId: or(individualId, $value.individualId), individualClientReferenceId: or(individualClientReferenceId, $value.individualClientReferenceId), isHeadOfHousehold: isHeadOfHousehold ?? $value.isHeadOfHousehold, clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: or(clientAuditDetails, $value.clientAuditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class IdentifierSearchModelMapper extends BaseMapper<IdentifierSearchModel> {
  ...
  @override int hash(IdentifierSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.identifierType) ^ Mapper.hash(self.identifierId) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId);
  @override bool equals(IdentifierSearchModel self, IdentifierSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.identifierType, other.identifierType) && Mapper.isEqual(self.identifierId, other.identifierId) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class IdentifierModelMapper extends BaseMapper<IdentifierModel> {
  ...
  Map<String, dynamic> toMap(IdentifierModel i) => {if (Mapper.i.$enc(i.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(i.additionalFields, 'additionalFields'), if (Mapper.i.$enc(i.id, 'id') != null) 'id': Mapper.i.$enc(i.id, 'id'), if (Mapper.i.$enc(i.identifierType, 'identifierType') != null) 'identifierType': Mapper.i.$enc(i.identifierType, 'identifierType'), if (Mapper.i.$enc(i.identifierId, 'identifierId') != null) 'identifierId': Mapper.i.$enc(i.identifierId, 'identifierId'), 'clientReferenceId': Mapper.i.$enc(i.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(i.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(i.tenantId, 'tenantId'), if (Mapper.i.$enc(i.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(i.rowVersion, 'rowVersion'), if (Mapper.i.$enc(i.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(i.auditDetails, 'auditDetails'), if (Mapper.i.$enc(i.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(i.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(i.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(i.isDeleted, 'isDeleted')};

  @override String stringify(IdentifierModel self) => 'IdentifierModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, identifierType: ${Mapper.asString(self.identifierType)}, identifierId: ${Mapper.asString(self.identifierId)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(IdentifierModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.identifierType) ^ Mapper.hash(self.identifierId) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(IdentifierModel self, IdentifierModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.identifierType, other.identifierType) && Mapper.isEqual(self.identifierId, other.identifierId) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class IdentifierModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({IdentifierAdditionalFields? additionalFields, String? id, String? identifierType, String? identifierId, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class IndividualSearchModelMapper extends BaseMapper<IndividualSearchModel> {
  ...
  @override int hash(IndividualSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.dateOfBirth) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.name) ^ Mapper.hash(self.gender) ^ Mapper.hash(self.identifiers);
  @override bool equals(IndividualSearchModel self, IndividualSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.dateOfBirth, other.dateOfBirth) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.gender, other.gender) && Mapper.isEqual(self.identifiers, other.identifiers);
...
class LocalitySearchModelMapper extends BaseMapper<LocalitySearchModel> {
  ...
  @override int hash(LocalitySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.code) ^ Mapper.hash(self.name) ^ Mapper.hash(self.tenantId);
  @override bool equals(LocalitySearchModel self, LocalitySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class LocalityModelMapper extends BaseMapper<LocalityModel> {
  ...
  Map<String, dynamic> toMap(LocalityModel l) => {if (Mapper.i.$enc(l.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(l.additionalFields, 'additionalFields'), 'code': Mapper.i.$enc(l.code, 'code'), if (Mapper.i.$enc(l.name, 'name') != null) 'name': Mapper.i.$enc(l.name, 'name'), if (Mapper.i.$enc(l.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(l.tenantId, 'tenantId'), if (Mapper.i.$enc(l.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(l.rowVersion, 'rowVersion'), if (Mapper.i.$enc(l.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(l.auditDetails, 'auditDetails'), if (Mapper.i.$enc(l.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(l.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(l.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(l.isDeleted, 'isDeleted')};

  @override String stringify(LocalityModel self) => 'LocalityModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, code: ${Mapper.asString(self.code)}, name: ${Mapper.asString(self.name)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(LocalityModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.code) ^ Mapper.hash(self.name) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(LocalityModel self, LocalityModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class LocalityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({LocalityAdditionalFields? additionalFields, String? code, String? name, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class _LocalityModelCopyWithImpl<$R> extends BaseCopyWith<LocalityModel, $R> implements LocalityModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override ClientAuditDetailsCopyWith<$R>? get clientAuditDetails => $value.clientAuditDetails != null ? ClientAuditDetailsCopyWith($value.clientAuditDetails!, (v) => call(clientAuditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? code, Object? name = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? clientAuditDetails = $none, Object? isDeleted = $none}) => $then(LocalityModel(additionalFields: or(additionalFields, $value.additionalFields), code: code ?? $value.code, name: or(name, $value.name), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: or(clientAuditDetails, $value.clientAuditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class NameSearchModelMapper extends BaseMapper<NameSearchModel> {
  ...
  @override int hash(NameSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.givenName) ^ Mapper.hash(self.familyName) ^ Mapper.hash(self.otherNames) ^ Mapper.hash(self.tenantId);
  @override bool equals(NameSearchModel self, NameSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.givenName, other.givenName) && Mapper.isEqual(self.familyName, other.familyName) && Mapper.isEqual(self.otherNames, other.otherNames) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class NameModelMapper extends BaseMapper<NameModel> {
  ...
  Map<String, dynamic> toMap(NameModel n) => {if (Mapper.i.$enc(n.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(n.additionalFields, 'additionalFields'), if (Mapper.i.$enc(n.id, 'id') != null) 'id': Mapper.i.$enc(n.id, 'id'), if (Mapper.i.$enc(n.individualClientReferenceId, 'individualClientReferenceId') != null) 'individualClientReferenceId': Mapper.i.$enc(n.individualClientReferenceId, 'individualClientReferenceId'), if (Mapper.i.$enc(n.givenName, 'givenName') != null) 'givenName': Mapper.i.$enc(n.givenName, 'givenName'), if (Mapper.i.$enc(n.familyName, 'familyName') != null) 'familyName': Mapper.i.$enc(n.familyName, 'familyName'), if (Mapper.i.$enc(n.otherNames, 'otherNames') != null) 'otherNames': Mapper.i.$enc(n.otherNames, 'otherNames'), if (Mapper.i.$enc(n.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(n.tenantId, 'tenantId'), if (Mapper.i.$enc(n.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(n.rowVersion, 'rowVersion'), if (Mapper.i.$enc(n.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(n.auditDetails, 'auditDetails'), if (Mapper.i.$enc(n.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(n.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(n.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(n.isDeleted, 'isDeleted')};

  @override String stringify(NameModel self) => 'NameModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, individualClientReferenceId: ${Mapper.asString(self.individualClientReferenceId)}, givenName: ${Mapper.asString(self.givenName)}, familyName: ${Mapper.asString(self.familyName)}, otherNames: ${Mapper.asString(self.otherNames)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(NameModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.individualClientReferenceId) ^ Mapper.hash(self.givenName) ^ Mapper.hash(self.familyName) ^ Mapper.hash(self.otherNames) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(NameModel self, NameModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.individualClientReferenceId, other.individualClientReferenceId) && Mapper.isEqual(self.givenName, other.givenName) && Mapper.isEqual(self.familyName, other.familyName) && Mapper.isEqual(self.otherNames, other.otherNames) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class NameModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({NameAdditionalFields? additionalFields, String? id, String? individualClientReferenceId, String? givenName, String? familyName, String? otherNames, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class ProductSearchModelMapper extends BaseMapper<ProductSearchModel> {
  ...
  @override int hash(ProductSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.type) ^ Mapper.hash(self.name) ^ Mapper.hash(self.manufacturer) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId);
  @override bool equals(ProductSearchModel self, ProductSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.type, other.type) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.manufacturer, other.manufacturer) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class ProductModelMapper extends BaseMapper<ProductModel> {
  ...
  Map<String, dynamic> toMap(ProductModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), if (Mapper.i.$enc(p.id, 'id') != null) 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.type, 'type') != null) 'type': Mapper.i.$enc(p.type, 'type'), if (Mapper.i.$enc(p.name, 'name') != null) 'name': Mapper.i.$enc(p.name, 'name'), if (Mapper.i.$enc(p.manufacturer, 'manufacturer') != null) 'manufacturer': Mapper.i.$enc(p.manufacturer, 'manufacturer'), 'clientReferenceId': Mapper.i.$enc(p.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProductModel self) => 'ProductModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, type: ${Mapper.asString(self.type)}, name: ${Mapper.asString(self.name)}, manufacturer: ${Mapper.asString(self.manufacturer)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProductModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.type) ^ Mapper.hash(self.name) ^ Mapper.hash(self.manufacturer) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProductModel self, ProductModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.type, other.type) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.manufacturer, other.manufacturer) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProductModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ProductAdditionalFields? additionalFields, String? id, String? type, String? name, String? manufacturer, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class _ProductModelCopyWithImpl<$R> extends BaseCopyWith<ProductModel, $R> implements ProductModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override ClientAuditDetailsCopyWith<$R>? get clientAuditDetails => $value.clientAuditDetails != null ? ClientAuditDetailsCopyWith($value.clientAuditDetails!, (v) => call(clientAuditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? type = $none, Object? name = $none, Object? manufacturer = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? clientAuditDetails = $none, Object? isDeleted = $none}) => $then(ProductModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), type: or(type, $value.type), name: or(name, $value.name), manufacturer: or(manufacturer, $value.manufacturer), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: or(clientAuditDetails, $value.clientAuditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProductVariantSearchModelMapper extends BaseMapper<ProductVariantSearchModel> {
  ...
  @override int hash(ProductVariantSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.productId) ^ Mapper.hash(self.sku) ^ Mapper.hash(self.variation) ^ Mapper.hash(self.tenantId);
  @override bool equals(ProductVariantSearchModel self, ProductVariantSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.productId, other.productId) && Mapper.isEqual(self.sku, other.sku) && Mapper.isEqual(self.variation, other.variation) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class ProductVariantModelMapper extends BaseMapper<ProductVariantModel> {
  ...
  Map<String, dynamic> toMap(ProductVariantModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.productId, 'productId') != null) 'productId': Mapper.i.$enc(p.productId, 'productId'), if (Mapper.i.$enc(p.sku, 'sku') != null) 'sku': Mapper.i.$enc(p.sku, 'sku'), if (Mapper.i.$enc(p.variation, 'variation') != null) 'variation': Mapper.i.$enc(p.variation, 'variation'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};
...
abstract class ProductVariantModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ProductVariantAdditionalFields? additionalFields, String? id, String? productId, String? sku, String? variation, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class ProjectSearchModelMapper extends BaseMapper<ProjectSearchModel> {
  ...
  @override int hash(ProjectSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectTypeId) ^ Mapper.hash(self.projectNumber) ^ Mapper.hash(self.subProjectTypeId) ^ Mapper.hash(self.isTaskEnabled) ^ Mapper.hash(self.parent) ^ Mapper.hash(self.department) ^ Mapper.hash(self.referenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.startDateTime) ^ Mapper.hash(self.endDateTime);
  @override bool equals(ProjectSearchModel self, ProjectSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectTypeId, other.projectTypeId) && Mapper.isEqual(self.projectNumber, other.projectNumber) && Mapper.isEqual(self.subProjectTypeId, other.subProjectTypeId) && Mapper.isEqual(self.isTaskEnabled, other.isTaskEnabled) && Mapper.isEqual(self.parent, other.parent) && Mapper.isEqual(self.department, other.department) && Mapper.isEqual(self.referenceId, other.referenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.startDateTime, other.startDateTime) && Mapper.isEqual(self.endDateTime, other.endDateTime);
...
class ProjectBeneficiarySearchModelMapper extends BaseMapper<ProjectBeneficiarySearchModel> {
  ...
  @override int hash(ProjectBeneficiarySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.beneficiaryId) ^ Mapper.hash(self.beneficiaryClientReferenceId) ^ Mapper.hash(self.beneficiaryRegistrationDateLte) ^ Mapper.hash(self.beneficiaryRegistrationDateGte) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.dateOfRegistrationTime);
  @override bool equals(ProjectBeneficiarySearchModel self, ProjectBeneficiarySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.beneficiaryId, other.beneficiaryId) && Mapper.isEqual(self.beneficiaryClientReferenceId, other.beneficiaryClientReferenceId) && Mapper.isEqual(self.beneficiaryRegistrationDateLte, other.beneficiaryRegistrationDateLte) && Mapper.isEqual(self.beneficiaryRegistrationDateGte, other.beneficiaryRegistrationDateGte) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.dateOfRegistrationTime, other.dateOfRegistrationTime);
...
class ProjectBeneficiaryModelMapper extends BaseMapper<ProjectBeneficiaryModel> {
  ...
  Map<String, dynamic> toMap(ProjectBeneficiaryModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), if (Mapper.i.$enc(p.id, 'id') != null) 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.projectId, 'projectId') != null) 'projectId': Mapper.i.$enc(p.projectId, 'projectId'), if (Mapper.i.$enc(p.beneficiaryId, 'beneficiaryId') != null) 'beneficiaryId': Mapper.i.$enc(p.beneficiaryId, 'beneficiaryId'), if (Mapper.i.$enc(p.beneficiaryClientReferenceId, 'beneficiaryClientReferenceId') != null) 'beneficiaryClientReferenceId': Mapper.i.$enc(p.beneficiaryClientReferenceId, 'beneficiaryClientReferenceId'), 'clientReferenceId': Mapper.i.$enc(p.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), 'dateOfRegistration': Mapper.i.$enc(p.dateOfRegistration, 'dateOfRegistration'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};
  ...
  @override int hash(ProjectBeneficiaryModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.beneficiaryId) ^ Mapper.hash(self.beneficiaryClientReferenceId) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.dateOfRegistrationTime) ^ Mapper.hash(self.additionalFields);
...
abstract class ProjectBeneficiaryModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ProjectBeneficiaryAdditionalFields? additionalFields, String? id, String? projectId, String? beneficiaryId, String? beneficiaryClientReferenceId, String? clientReferenceId, String? tenantId, int? rowVersion, int? dateOfRegistration, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class ProjectFacilitySearchModelMapper extends BaseMapper<ProjectFacilitySearchModel> {
  ...
  @override int hash(ProjectFacilitySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.facilityId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId);
  @override bool equals(ProjectFacilitySearchModel self, ProjectFacilitySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.facilityId, other.facilityId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class ProjectFacilityModelMapper extends BaseMapper<ProjectFacilityModel> {
  ...
  Map<String, dynamic> toMap(ProjectFacilityModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), 'id': Mapper.i.$enc(p.id, 'id'), 'facilityId': Mapper.i.$enc(p.facilityId, 'facilityId'), 'projectId': Mapper.i.$enc(p.projectId, 'projectId'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProjectFacilityModel self) => 'ProjectFacilityModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, facilityId: ${Mapper.asString(self.facilityId)}, projectId: ${Mapper.asString(self.projectId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectFacilityModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.facilityId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectFacilityModel self, ProjectFacilityModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.facilityId, other.facilityId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProjectFacilityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ProjectFacilityAdditionalFields? additionalFields, String? id, String? facilityId, String? projectId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class ProjectProductVariantSearchModelMapper extends BaseMapper<ProjectProductVariantSearchModel> {
  ...
  @override int hash(ProjectProductVariantSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.productVariantId) ^ Mapper.hash(self.tenantId);
  @override bool equals(ProjectProductVariantSearchModel self, ProjectProductVariantSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.productVariantId, other.productVariantId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class ProjectProductVariantModelMapper extends BaseMapper<ProjectProductVariantModel> {
  ...
  Map<String, dynamic> toMap(ProjectProductVariantModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), 'productVariantId': Mapper.i.$enc(p.productVariantId, 'productVariantId'), if (Mapper.i.$enc(p.type, 'type') != null) 'type': Mapper.i.$enc(p.type, 'type'), if (Mapper.i.$enc(p.isBaseUnitVariant, 'isBaseUnitVariant') != null) 'isBaseUnitVariant': Mapper.i.$enc(p.isBaseUnitVariant, 'isBaseUnitVariant'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};
...
abstract class ProjectProductVariantModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ProjectProductVariantAdditionalFields? additionalFields, String? productVariantId, String? type, bool? isBaseUnitVariant, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class _ProjectProductVariantModelCopyWithImpl<$R> extends BaseCopyWith<ProjectProductVariantModel, $R> implements ProjectProductVariantModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override ClientAuditDetailsCopyWith<$R>? get clientAuditDetails => $value.clientAuditDetails != null ? ClientAuditDetailsCopyWith($value.clientAuditDetails!, (v) => call(clientAuditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? productVariantId, Object? type = $none, Object? isBaseUnitVariant = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, Object? clientAuditDetails = $none, Object? isDeleted = $none}) => $then(ProjectProductVariantModel(additionalFields: or(additionalFields, $value.additionalFields), productVariantId: productVariantId ?? $value.productVariantId, type: or(type, $value.type), isBaseUnitVariant: or(isBaseUnitVariant, $value.isBaseUnitVariant), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: or(clientAuditDetails, $value.clientAuditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProjectResourceSearchModelMapper extends BaseMapper<ProjectResourceSearchModel> {
  ...
  @override int hash(ProjectResourceSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId);
  @override bool equals(ProjectResourceSearchModel self, ProjectResourceSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class ProjectResourceModelMapper extends BaseMapper<ProjectResourceModel> {
  ...
  Map<String, dynamic> toMap(ProjectResourceModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), if (Mapper.i.$enc(p.id, 'id') != null) 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.projectId, 'projectId') != null) 'projectId': Mapper.i.$enc(p.projectId, 'projectId'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), 'resource': Mapper.i.$enc(p.resource, 'resource'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(p.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProjectResourceModel self) => 'ProjectResourceModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, projectId: ${Mapper.asString(self.projectId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, resource: ${Mapper.asString(self.resource)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectResourceModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.resource) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectResourceModel self, ProjectResourceModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.resource, other.resource) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProjectResourceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ProjectResourceAdditionalFields? additionalFields, String? id, String? projectId, String? tenantId, int? rowVersion, ProjectProductVariantModel? resource, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class ProjectStaffSearchModelMapper extends BaseMapper<ProjectStaffSearchModel> {
  ...
  @override int hash(ProjectStaffSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.staffId) ^ Mapper.hash(self.userId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.startDateTime) ^ Mapper.hash(self.endDateTime);
  @override bool equals(ProjectStaffSearchModel self, ProjectStaffSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.staffId, other.staffId) && Mapper.isEqual(self.userId, other.userId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.startDateTime, other.startDateTime) && Mapper.isEqual(self.endDateTime, other.endDateTime);
...
class ProjectStaffModelMapper extends BaseMapper<ProjectStaffModel> {
  ...
  @override String stringify(ProjectStaffModel self) => 'ProjectStaffModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, staffId: ${Mapper.asString(self.staffId)}, userId: ${Mapper.asString(self.userId)}, projectId: ${Mapper.asString(self.projectId)}, channel: ${Mapper.asString(self.channel)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, startDateTime: ${Mapper.asString(self.startDateTime)}, endDateTime: ${Mapper.asString(self.endDateTime)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectStaffModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.staffId) ^ Mapper.hash(self.userId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.channel) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.startDateTime) ^ Mapper.hash(self.endDateTime) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectStaffModel self, ProjectStaffModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.staffId, other.staffId) && Mapper.isEqual(self.userId, other.userId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.channel, other.channel) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.startDateTime, other.startDateTime) && Mapper.isEqual(self.endDateTime, other.endDateTime) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProjectStaffModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ProjectStaffAdditionalFields? additionalFields, String? id, String? staffId, String? userId, String? projectId, String? channel, String? tenantId, int? rowVersion, int? startDate, int? endDate, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class ProjectTypeSearchModelMapper extends BaseMapper<ProjectTypeSearchModel> {
  ...
  @override int hash(ProjectTypeSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId);
...
class ServiceSearchModelMapper extends BaseMapper<ServiceSearchModel> {
  ...
  @override int hash(ServiceSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.clientId) ^ Mapper.hash(self.serviceDefId) ^ Mapper.hash(self.accountId) ^ Mapper.hash(self.createdAt) ^ Mapper.hash(self.tenantId);
  @override bool equals(ServiceSearchModel self, ServiceSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.clientId, other.clientId) && Mapper.isEqual(self.serviceDefId, other.serviceDefId) && Mapper.isEqual(self.accountId, other.accountId) && Mapper.isEqual(self.createdAt, other.createdAt) && Mapper.isEqual(self.tenantId, other.tenantId);
...
abstract class ServiceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ServiceAdditionalFields? additionalFields, String? id, String? clientId, String? serviceDefId, bool? isActive, String? accountId, String? additionalDetails, String? createdAt, String? tenantId, int? rowVersion, List<ServiceAttributesModel>? attributes, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class ServiceAttributesSearchModelMapper extends BaseMapper<ServiceAttributesSearchModel> {
  ...
  @override int hash(ServiceAttributesSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId);
...
abstract class ServiceAttributesModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ServiceAttributesAdditionalFields? additionalFields, String? attributeCode, dynamic value, String? dataType, String? referenceId, dynamic additionalDetails, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class ServiceDefinitionSearchModelMapper extends BaseMapper<ServiceDefinitionSearchModel> {
  ...
  @override int hash(ServiceDefinitionSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.isActive);
  @override bool equals(ServiceDefinitionSearchModel self, ServiceDefinitionSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.isActive, other.isActive);
...
class ServiceDefinitionModelMapper extends BaseMapper<ServiceDefinitionModel> {
  ...
  @override String stringify(ServiceDefinitionModel self) => 'ServiceDefinitionModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, tenantId: ${Mapper.asString(self.tenantId)}, code: ${Mapper.asString(self.code)}, isActive: ${Mapper.asString(self.isActive)}, rowVersion: ${Mapper.asString(self.rowVersion)}, attributes: ${Mapper.asString(self.attributes)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ServiceDefinitionModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.attributes) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ServiceDefinitionModel self, ServiceDefinitionModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.attributes, other.attributes) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ServiceDefinitionModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({ServiceDefinitionAdditionalFields? additionalFields, String? id, String? tenantId, String? code, bool? isActive, int? rowVersion, List<AttributesModel>? attributes, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class _ServiceDefinitionModelCopyWithImpl<$R> extends BaseCopyWith<ServiceDefinitionModel, $R> implements ServiceDefinitionModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override ClientAuditDetailsCopyWith<$R>? get clientAuditDetails => $value.clientAuditDetails != null ? ClientAuditDetailsCopyWith($value.clientAuditDetails!, (v) => call(clientAuditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? tenantId = $none, Object? code = $none, Object? isActive = $none, Object? rowVersion = $none, Object? attributes = $none, Object? auditDetails = $none, Object? clientAuditDetails = $none, Object? isDeleted = $none}) => $then(ServiceDefinitionModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), tenantId: or(tenantId, $value.tenantId), code: or(code, $value.code), isActive: or(isActive, $value.isActive), rowVersion: or(rowVersion, $value.rowVersion), attributes: or(attributes, $value.attributes), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: or(clientAuditDetails, $value.clientAuditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class StockReconciliationModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({StockReconciliationAdditionalFields? additionalFields, String? id, String? tenantId, String? facilityId, String? productVariantId, String? referenceId, String? referenceIdType, int? physicalCount, int? calculatedCount, String? commentsOnReconciliation, String? clientReferenceId, int? rowVersion, int? dateOfReconciliation, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class TargetSearchModelMapper extends BaseMapper<TargetSearchModel> {
  ...
  @override String stringify(TargetSearchModel self) => 'TargetSearchModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, auditDetails: ${Mapper.asString(self.auditDetails)}, additionalFields: ${Mapper.asString(self.additionalFields)}, tenantId: ${Mapper.asString(self.tenantId)})';
  @override int hash(TargetSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.tenantId);
  @override bool equals(TargetSearchModel self, TargetSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.tenantId, other.tenantId);
...
class TargetModelMapper extends BaseMapper<TargetModel> {
  ...
  Map<String, dynamic> toMap(TargetModel t) => {if (Mapper.i.$enc(t.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(t.additionalFields, 'additionalFields'), 'id': Mapper.i.$enc(t.id, 'id'), if (Mapper.i.$enc(t.clientReferenceId, 'clientReferenceId') != null) 'clientReferenceId': Mapper.i.$enc(t.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(t.totalNo, 'totalNo') != null) 'totalNo': Mapper.i.$enc(t.totalNo, 'totalNo'), if (Mapper.i.$enc(t.targetNo, 'targetNo') != null) 'targetNo': Mapper.i.$enc(t.targetNo, 'targetNo'), if (Mapper.i.$enc(t.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(t.tenantId, 'tenantId'), if (Mapper.i.$enc(t.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(t.rowVersion, 'rowVersion'), if (Mapper.i.$enc(t.beneficiaryType, 'beneficiaryType') != null) 'beneficiaryType': Mapper.i.$enc(t.beneficiaryType, 'beneficiaryType'), if (Mapper.i.$enc(t.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(t.auditDetails, 'auditDetails'), if (Mapper.i.$enc(t.clientAuditDetails, 'clientAuditDetails') != null) 'clientAuditDetails': Mapper.i.$enc(t.clientAuditDetails, 'clientAuditDetails'), if (Mapper.i.$enc(t.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(t.isDeleted, 'isDeleted')};
  ...
  @override int hash(TargetModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.totalNo) ^ Mapper.hash(self.targetNo) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.beneficiaryType) ^ Mapper.hash(self.additionalFields);
  @override bool equals(TargetModel self, TargetModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.totalNo, other.totalNo) && Mapper.isEqual(self.targetNo, other.targetNo) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.beneficiaryType, other.beneficiaryType) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class TargetModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({TargetAdditionalFields? additionalFields, String? id, String? clientReferenceId, double? totalNo, double? targetNo, String? tenantId, int? rowVersion, BeneficiaryType? beneficiaryType, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class TaskSearchModelMapper extends BaseMapper<TaskSearchModel> {
  ...
  @override int hash(TaskSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.projectBeneficiaryId) ^ Mapper.hash(self.projectBeneficiaryClientReferenceId) ^ Mapper.hash(self.createdBy) ^ Mapper.hash(self.status) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.plannedStartDateTime) ^ Mapper.hash(self.plannedEndDateTime) ^ Mapper.hash(self.actualStartDateTime) ^ Mapper.hash(self.actualEndDateTime);
  @override bool equals(TaskSearchModel self, TaskSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.projectBeneficiaryId, other.projectBeneficiaryId) && Mapper.isEqual(self.projectBeneficiaryClientReferenceId, other.projectBeneficiaryClientReferenceId) && Mapper.isEqual(self.createdBy, other.createdBy) && Mapper.isEqual(self.status, other.status) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.plannedStartDateTime, other.plannedStartDateTime) && Mapper.isEqual(self.plannedEndDateTime, other.plannedEndDateTime) && Mapper.isEqual(self.actualStartDateTime, other.actualStartDateTime) && Mapper.isEqual(self.actualEndDateTime, other.actualEndDateTime);
...
class TaskModelMapper extends BaseMapper<TaskModel> {
  ...
  @override int hash(TaskModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.projectBeneficiaryId) ^ Mapper.hash(self.projectBeneficiaryClientReferenceId) ^ Mapper.hash(self.createdBy) ^ Mapper.hash(self.status) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.resources) ^ Mapper.hash(self.address) ^ Mapper.hash(self.plannedStartDateTime) ^ Mapper.hash(self.plannedEndDateTime) ^ Mapper.hash(self.actualStartDateTime) ^ Mapper.hash(self.actualEndDateTime) ^ Mapper.hash(self.createdDateTime) ^ Mapper.hash(self.additionalFields);
...
class TaskResourceSearchModelMapper extends BaseMapper<TaskResourceSearchModel> {
  ...
  @override int hash(TaskResourceSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId);
