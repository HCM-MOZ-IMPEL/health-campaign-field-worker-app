...
abstract class BoundarySearchModelCopyWith<$R> {
  ...
  $R call({String? boundaryType, String? tenantId, bool? isDeleted, List<String>? codes, String? boundaryCode});
...
class _BoundarySearchModelCopyWithImpl<$R> extends BaseCopyWith<BoundarySearchModel, $R> implements BoundarySearchModelCopyWith<$R> {
  ...
  @override $R call({Object? boundaryType = $none, Object? tenantId = $none, Object? isDeleted = $none, Object? codes = $none, Object? boundaryCode = $none}) => $then(BoundarySearchModel(boundaryType: or(boundaryType, $value.boundaryType), tenantId: or(tenantId, $value.tenantId), isDeleted: or(isDeleted, $value.isDeleted), codes: or(codes, $value.codes), boundaryCode: or(boundaryCode, $value.boundaryCode)));
}
...
abstract class BoundaryModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({String? code, String? name, String? label, String? latitude, String? longitude, String? materializedPath, String? tenantId, bool? isDeleted, int? boundaryNum, int? rowVersion, String? boundaryType, List<BoundaryModel>? children, AuditDetails? auditDetails});
...
class _BoundaryModelCopyWithImpl<$R> extends BaseCopyWith<BoundaryModel, $R> implements BoundaryModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? code = $none, Object? name = $none, Object? label = $none, Object? latitude = $none, Object? longitude = $none, Object? materializedPath = $none, Object? tenantId = $none, Object? isDeleted = $none, Object? boundaryNum = $none, Object? rowVersion = $none, Object? boundaryType = $none, List<BoundaryModel>? children, Object? auditDetails = $none}) => $then(BoundaryModel(code: or(code, $value.code), name: or(name, $value.name), label: or(label, $value.label), latitude: or(latitude, $value.latitude), longitude: or(longitude, $value.longitude), materializedPath: or(materializedPath, $value.materializedPath), tenantId: or(tenantId, $value.tenantId), isDeleted: or(isDeleted, $value.isDeleted), boundaryNum: or(boundaryNum, $value.boundaryNum), rowVersion: or(rowVersion, $value.rowVersion), boundaryType: or(boundaryType, $value.boundaryType), children: children ?? $value.children, auditDetails: or(auditDetails, $value.auditDetails)));
}
...
class HouseholdModelMapper extends BaseMapper<HouseholdModel> {
  ...
  @override String stringify(HouseholdModel self) => 'HouseholdModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, memberCount: ${Mapper.asString(self.memberCount)}, nonRecoverableError: ${Mapper.asString(self.nonRecoverableError)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, address: ${Mapper.asString(self.address)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(HouseholdModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.memberCount) ^ Mapper.hash(self.nonRecoverableError) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.address) ^ Mapper.hash(self.additionalFields);
  @override bool equals(HouseholdModel self, HouseholdModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.memberCount, other.memberCount) && Mapper.isEqual(self.nonRecoverableError, other.nonRecoverableError) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.address, other.address) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class HouseholdModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({HouseholdAdditionalFields? additionalFields, String? id, int? memberCount, bool? nonRecoverableError, String? clientReferenceId, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
...
class _HouseholdModelCopyWithImpl<$R> extends BaseCopyWith<HouseholdModel, $R> implements HouseholdModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override ClientAuditDetailsCopyWith<$R>? get clientAuditDetails => $value.clientAuditDetails != null ? ClientAuditDetailsCopyWith($value.clientAuditDetails!, (v) => call(clientAuditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? memberCount = $none, Object? nonRecoverableError = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? address = $none, Object? auditDetails = $none, Object? clientAuditDetails = $none, Object? isDeleted = $none}) => $then(HouseholdModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), memberCount: or(memberCount, $value.memberCount), nonRecoverableError: or(nonRecoverableError, $value.nonRecoverableError), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), address: or(address, $value.address), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: or(clientAuditDetails, $value.clientAuditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class TaskResourceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({TaskResourceAdditionalFields? additionalFields, String? clientReferenceId, String? taskId, String? id, String? productVariantId, String? quantity, bool? isDelivered, String? deliveryComment, bool? nonRecoverableError, String? tenantId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
