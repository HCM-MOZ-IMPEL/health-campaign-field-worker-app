...
class EntityModelMapper extends BaseMapper<EntityModel> {
  ...
  Map<String, dynamic> toMap(EntityModel e) => {'auditDetails': Mapper.i.$enc(e.auditDetails, 'auditDetails'), 'isDeleted': Mapper.i.$enc(e.isDeleted, 'isDeleted')};

  @override String stringify(EntityModel self) => 'EntityModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)})';
  @override int hash(EntityModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails);
  @override bool equals(EntityModel self, EntityModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails);
...
class AddressSearchModelMapper extends BaseMapper<AddressSearchModel> {
  ...
  AddressSearchModel fromMap(Map<String, dynamic> map) => AddressSearchModel.ignoreDeleted(id: Mapper.i.$getOpt(map, 'id'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), boundaryCode: Mapper.i.$getOpt(map, 'boundaryCode'));

  @override Function get encoder => (AddressSearchModel v) => encode(v);
  dynamic encode(AddressSearchModel v) => toMap(v);
  Map<String, dynamic> toMap(AddressSearchModel a) => {if (Mapper.i.$enc(a.id, 'id') != null) 'id': Mapper.i.$enc(a.id, 'id'), if (Mapper.i.$enc(a.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(a.tenantId, 'tenantId'), if (Mapper.i.$enc(a.boundaryCode, 'boundaryCode') != null) 'boundaryCode': Mapper.i.$enc(a.boundaryCode, 'boundaryCode')};
  ...
  @override int hash(AddressSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId);
...
class _AddressSearchModelCopyWithImpl<$R> extends BaseCopyWith<AddressSearchModel, $R> implements AddressSearchModelCopyWith<$R> {
  ...
  @override $R call({Object? id = $none, Object? tenantId = $none, Object? boundaryCode = $none}) => $then(AddressSearchModel.ignoreDeleted(id: or(id, $value.id), tenantId: or(tenantId, $value.tenantId), boundaryCode: or(boundaryCode, $value.boundaryCode)));
}
...
abstract class AddressModelCopyWith<$R> {
  ...
  $R call({AddressAdditionalFields? additionalFields, String? id, String? relatedClientReferenceId, String? doorNo, double? latitude, double? longitude, double? locationAccuracy, String? addressLine1, String? addressLine2, String? landmark, String? city, String? pincode, String? buildingName, String? street, String? boundaryType, String? boundary, String? tenantId, int? rowVersion, AddressType? type, LocalityModel? locality, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _AddressModelCopyWithImpl<$R> extends BaseCopyWith<AddressModel, $R> implements AddressModelCopyWith<$R> {
  ...
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? relatedClientReferenceId = $none, Object? doorNo = $none, Object? latitude = $none, Object? longitude = $none, Object? locationAccuracy = $none, Object? addressLine1 = $none, Object? addressLine2 = $none, Object? landmark = $none, Object? city = $none, Object? pincode = $none, Object? buildingName = $none, Object? street = $none, Object? boundaryType = $none, Object? boundary = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? type = $none, Object? locality = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(AddressModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), relatedClientReferenceId: or(relatedClientReferenceId, $value.relatedClientReferenceId), doorNo: or(doorNo, $value.doorNo), latitude: or(latitude, $value.latitude), longitude: or(longitude, $value.longitude), locationAccuracy: or(locationAccuracy, $value.locationAccuracy), addressLine1: or(addressLine1, $value.addressLine1), addressLine2: or(addressLine2, $value.addressLine2), landmark: or(landmark, $value.landmark), city: or(city, $value.city), pincode: or(pincode, $value.pincode), buildingName: or(buildingName, $value.buildingName), street: or(street, $value.street), boundaryType: or(boundaryType, $value.boundaryType), boundary: or(boundary, $value.boundary), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), type: or(type, $value.type), locality: or(locality, $value.locality), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class AttributesModelMapper extends BaseMapper<AttributesModel> {
  ...
  AttributesModel fromMap(Map<String, dynamic> map) => AttributesModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), dataType: Mapper.i.$getOpt(map, 'dataType'), referenceId: Mapper.i.$getOpt(map, 'referenceId'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), code: Mapper.i.$getOpt(map, 'code'), values: Mapper.i.$getOpt(map, 'values'), isActive: Mapper.i.$getOpt(map, 'isActive'), required: Mapper.i.$getOpt(map, 'required'), regex: Mapper.i.$getOpt(map, 'regex'), order: Mapper.i.$getOpt(map, 'order'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (AttributesModel v) => encode(v);
  dynamic encode(AttributesModel v) => toMap(v);
  Map<String, dynamic> toMap(AttributesModel a) => {if (Mapper.i.$enc(a.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(a.additionalFields, 'additionalFields'), if (Mapper.i.$enc(a.id, 'id') != null) 'id': Mapper.i.$enc(a.id, 'id'), if (Mapper.i.$enc(a.dataType, 'dataType') != null) 'dataType': Mapper.i.$enc(a.dataType, 'dataType'), if (Mapper.i.$enc(a.referenceId, 'referenceId') != null) 'referenceId': Mapper.i.$enc(a.referenceId, 'referenceId'), if (Mapper.i.$enc(a.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(a.tenantId, 'tenantId'), if (Mapper.i.$enc(a.code, 'code') != null) 'code': Mapper.i.$enc(a.code, 'code'), if (Mapper.i.$enc(a.values, 'values') != null) 'values': Mapper.i.$enc(a.values, 'values'), if (Mapper.i.$enc(a.isActive, 'isActive') != null) 'isActive': Mapper.i.$enc(a.isActive, 'isActive'), if (Mapper.i.$enc(a.required, 'required') != null) 'required': Mapper.i.$enc(a.required, 'required'), if (Mapper.i.$enc(a.regex, 'regex') != null) 'regex': Mapper.i.$enc(a.regex, 'regex'), if (Mapper.i.$enc(a.order, 'order') != null) 'order': Mapper.i.$enc(a.order, 'order'), if (Mapper.i.$enc(a.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(a.rowVersion, 'rowVersion'), if (Mapper.i.$enc(a.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(a.auditDetails, 'auditDetails'), if (Mapper.i.$enc(a.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(a.isDeleted, 'isDeleted')};

  @override String stringify(AttributesModel self) => 'AttributesModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, dataType: ${Mapper.asString(self.dataType)}, referenceId: ${Mapper.asString(self.referenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, code: ${Mapper.asString(self.code)}, values: ${Mapper.asString(self.values)}, isActive: ${Mapper.asString(self.isActive)}, required: ${Mapper.asString(self.required)}, regex: ${Mapper.asString(self.regex)}, order: ${Mapper.asString(self.order)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(AttributesModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.dataType) ^ Mapper.hash(self.referenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.values) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.required) ^ Mapper.hash(self.regex) ^ Mapper.hash(self.order) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(AttributesModel self, AttributesModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.dataType, other.dataType) && Mapper.isEqual(self.referenceId, other.referenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.values, other.values) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.required, other.required) && Mapper.isEqual(self.regex, other.regex) && Mapper.isEqual(self.order, other.order) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class AttributesModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({AttributesAdditionalFields? additionalFields, String? id, String? dataType, String? referenceId, String? tenantId, String? code, List<String>? values, String? isActive, bool? required, String? regex, int? order, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _AttributesModelCopyWithImpl<$R> extends BaseCopyWith<AttributesModel, $R> implements AttributesModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? dataType = $none, Object? referenceId = $none, Object? tenantId = $none, Object? code = $none, Object? values = $none, Object? isActive = $none, Object? required = $none, Object? regex = $none, Object? order = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(AttributesModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), dataType: or(dataType, $value.dataType), referenceId: or(referenceId, $value.referenceId), tenantId: or(tenantId, $value.tenantId), code: or(code, $value.code), values: or(values, $value.values), isActive: or(isActive, $value.isActive), required: or(required, $value.required), regex: or(regex, $value.regex), order: or(order, $value.order), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class DocumentModelMapper extends BaseMapper<DocumentModel> {
  ...
  Map<String, dynamic> toMap(DocumentModel d) => {if (Mapper.i.$enc(d.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(d.additionalFields, 'additionalFields'), if (Mapper.i.$enc(d.id, 'id') != null) 'id': Mapper.i.$enc(d.id, 'id'), if (Mapper.i.$enc(d.documentType, 'documentType') != null) 'documentType': Mapper.i.$enc(d.documentType, 'documentType'), if (Mapper.i.$enc(d.fileStoreId, 'fileStoreId') != null) 'fileStoreId': Mapper.i.$enc(d.fileStoreId, 'fileStoreId'), if (Mapper.i.$enc(d.documentUid, 'documentUid') != null) 'documentUid': Mapper.i.$enc(d.documentUid, 'documentUid'), 'clientReferenceId': Mapper.i.$enc(d.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(d.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(d.tenantId, 'tenantId'), if (Mapper.i.$enc(d.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(d.rowVersion, 'rowVersion'), if (Mapper.i.$enc(d.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(d.auditDetails, 'auditDetails'), if (Mapper.i.$enc(d.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(d.isDeleted, 'isDeleted')};

  @override String stringify(DocumentModel self) => 'DocumentModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, documentType: ${Mapper.asString(self.documentType)}, fileStoreId: ${Mapper.asString(self.fileStoreId)}, documentUid: ${Mapper.asString(self.documentUid)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(DocumentModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.documentType) ^ Mapper.hash(self.fileStoreId) ^ Mapper.hash(self.documentUid) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(DocumentModel self, DocumentModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.documentType, other.documentType) && Mapper.isEqual(self.fileStoreId, other.fileStoreId) && Mapper.isEqual(self.documentUid, other.documentUid) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class DocumentModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({DocumentAdditionalFields? additionalFields, String? id, String? documentType, String? fileStoreId, String? documentUid, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _DocumentModelCopyWithImpl<$R> extends BaseCopyWith<DocumentModel, $R> implements DocumentModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? documentType = $none, Object? fileStoreId = $none, Object? documentUid = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(DocumentModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), documentType: or(documentType, $value.documentType), fileStoreId: or(fileStoreId, $value.fileStoreId), documentUid: or(documentUid, $value.documentUid), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class FacilityModelMapper extends BaseMapper<FacilityModel> {
  ...
  FacilityModel fromMap(Map<String, dynamic> map) => FacilityModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), name: Mapper.i.$getOpt(map, 'name'), isPermanent: Mapper.i.$getOpt(map, 'isPermanent'), usage: Mapper.i.$getOpt(map, 'usage'), storageCapacity: Mapper.i.$getOpt(map, 'storageCapacity'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), address: Mapper.i.$getOpt(map, 'address'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (FacilityModel v) => encode(v);
  dynamic encode(FacilityModel v) => toMap(v);
  Map<String, dynamic> toMap(FacilityModel f) => {if (Mapper.i.$enc(f.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(f.additionalFields, 'additionalFields'), 'id': Mapper.i.$enc(f.id, 'id'), if (Mapper.i.$enc(f.name, 'name') != null) 'name': Mapper.i.$enc(f.name, 'name'), if (Mapper.i.$enc(f.isPermanent, 'isPermanent') != null) 'isPermanent': Mapper.i.$enc(f.isPermanent, 'isPermanent'), if (Mapper.i.$enc(f.usage, 'usage') != null) 'usage': Mapper.i.$enc(f.usage, 'usage'), if (Mapper.i.$enc(f.storageCapacity, 'storageCapacity') != null) 'storageCapacity': Mapper.i.$enc(f.storageCapacity, 'storageCapacity'), if (Mapper.i.$enc(f.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(f.tenantId, 'tenantId'), if (Mapper.i.$enc(f.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(f.rowVersion, 'rowVersion'), if (Mapper.i.$enc(f.address, 'address') != null) 'address': Mapper.i.$enc(f.address, 'address'), if (Mapper.i.$enc(f.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(f.auditDetails, 'auditDetails'), if (Mapper.i.$enc(f.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(f.isDeleted, 'isDeleted')};

  @override String stringify(FacilityModel self) => 'FacilityModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, name: ${Mapper.asString(self.name)}, isPermanent: ${Mapper.asString(self.isPermanent)}, usage: ${Mapper.asString(self.usage)}, storageCapacity: ${Mapper.asString(self.storageCapacity)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, address: ${Mapper.asString(self.address)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(FacilityModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.name) ^ Mapper.hash(self.isPermanent) ^ Mapper.hash(self.usage) ^ Mapper.hash(self.storageCapacity) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.address) ^ Mapper.hash(self.additionalFields);
  @override bool equals(FacilityModel self, FacilityModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.isPermanent, other.isPermanent) && Mapper.isEqual(self.usage, other.usage) && Mapper.isEqual(self.storageCapacity, other.storageCapacity) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.address, other.address) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class FacilityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({FacilityAdditionalFields? additionalFields, String? id, String? name, bool? isPermanent, String? usage, int? storageCapacity, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class HouseholdSearchModelMapper extends BaseMapper<HouseholdSearchModel> {
  ...
  HouseholdSearchModel fromMap(Map<String, dynamic> map) => HouseholdSearchModel.ignoreDeleted(id: Mapper.i.$getOpt(map, 'id'), memberCount: Mapper.i.$getOpt(map, 'memberCount'), clientReferenceId: Mapper.i.$getOpt(map, 'clientReferenceId'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), boundaryCode: Mapper.i.$getOpt(map, 'boundaryCode'));

  @override Function get encoder => (HouseholdSearchModel v) => encode(v);
  dynamic encode(HouseholdSearchModel v) => toMap(v);
  Map<String, dynamic> toMap(HouseholdSearchModel h) => {if (Mapper.i.$enc(h.id, 'id') != null) 'id': Mapper.i.$enc(h.id, 'id'), if (Mapper.i.$enc(h.memberCount, 'memberCount') != null) 'memberCount': Mapper.i.$enc(h.memberCount, 'memberCount'), if (Mapper.i.$enc(h.clientReferenceId, 'clientReferenceId') != null) 'clientReferenceId': Mapper.i.$enc(h.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(h.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(h.tenantId, 'tenantId'), if (Mapper.i.$enc(h.boundaryCode, 'boundaryCode') != null) 'boundaryCode': Mapper.i.$enc(h.boundaryCode, 'boundaryCode')};
  ...
  @override int hash(HouseholdSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.memberCount) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId);
  @override bool equals(HouseholdSearchModel self, HouseholdSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.memberCount, other.memberCount) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
abstract class HouseholdSearchModelCopyWith<$R> {
  ...
  $R call({String? id, int? memberCount, List<String>? clientReferenceId, String? tenantId, String? boundaryCode});
...
class HouseholdModelMapper extends BaseMapper<HouseholdModel> {
  ...
  Map<String, dynamic> toMap(HouseholdModel h) => {if (Mapper.i.$enc(h.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(h.additionalFields, 'additionalFields'), if (Mapper.i.$enc(h.id, 'id') != null) 'id': Mapper.i.$enc(h.id, 'id'), if (Mapper.i.$enc(h.memberCount, 'memberCount') != null) 'memberCount': Mapper.i.$enc(h.memberCount, 'memberCount'), 'clientReferenceId': Mapper.i.$enc(h.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(h.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(h.tenantId, 'tenantId'), if (Mapper.i.$enc(h.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(h.rowVersion, 'rowVersion'), if (Mapper.i.$enc(h.address, 'address') != null) 'address': Mapper.i.$enc(h.address, 'address'), if (Mapper.i.$enc(h.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(h.auditDetails, 'auditDetails'), if (Mapper.i.$enc(h.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(h.isDeleted, 'isDeleted')};
...
abstract class HouseholdModelCopyWith<$R> {
  ...
  AddressModelCopyWith<$R>? get address;
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({HouseholdAdditionalFields? additionalFields, String? id, int? memberCount, String? clientReferenceId, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _HouseholdModelCopyWithImpl<$R> extends BaseCopyWith<HouseholdModel, $R> implements HouseholdModelCopyWith<$R> {
  ...
  @override AddressModelCopyWith<$R>? get address => $value.address != null ? AddressModelCopyWith($value.address!, (v) => call(address: v)) : null;
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? memberCount = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? address = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(HouseholdModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), memberCount: or(memberCount, $value.memberCount), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), address: or(address, $value.address), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class HouseholdMemberModelMapper extends BaseMapper<HouseholdMemberModel> {
  ...
  Map<String, dynamic> toMap(HouseholdMemberModel h) => {if (Mapper.i.$enc(h.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(h.additionalFields, 'additionalFields'), if (Mapper.i.$enc(h.id, 'id') != null) 'id': Mapper.i.$enc(h.id, 'id'), if (Mapper.i.$enc(h.householdId, 'householdId') != null) 'householdId': Mapper.i.$enc(h.householdId, 'householdId'), if (Mapper.i.$enc(h.householdClientReferenceId, 'householdClientReferenceId') != null) 'householdClientReferenceId': Mapper.i.$enc(h.householdClientReferenceId, 'householdClientReferenceId'), if (Mapper.i.$enc(h.individualId, 'individualId') != null) 'individualId': Mapper.i.$enc(h.individualId, 'individualId'), if (Mapper.i.$enc(h.individualClientReferenceId, 'individualClientReferenceId') != null) 'individualClientReferenceId': Mapper.i.$enc(h.individualClientReferenceId, 'individualClientReferenceId'), 'isHeadOfHousehold': Mapper.i.$enc(h.isHeadOfHousehold, 'isHeadOfHousehold'), 'clientReferenceId': Mapper.i.$enc(h.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(h.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(h.tenantId, 'tenantId'), if (Mapper.i.$enc(h.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(h.rowVersion, 'rowVersion'), if (Mapper.i.$enc(h.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(h.auditDetails, 'auditDetails'), if (Mapper.i.$enc(h.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(h.isDeleted, 'isDeleted')};

  @override String stringify(HouseholdMemberModel self) => 'HouseholdMemberModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, householdId: ${Mapper.asString(self.householdId)}, householdClientReferenceId: ${Mapper.asString(self.householdClientReferenceId)}, individualId: ${Mapper.asString(self.individualId)}, individualClientReferenceId: ${Mapper.asString(self.individualClientReferenceId)}, isHeadOfHousehold: ${Mapper.asString(self.isHeadOfHousehold)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(HouseholdMemberModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.householdId) ^ Mapper.hash(self.householdClientReferenceId) ^ Mapper.hash(self.individualId) ^ Mapper.hash(self.individualClientReferenceId) ^ Mapper.hash(self.isHeadOfHousehold) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(HouseholdMemberModel self, HouseholdMemberModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.householdId, other.householdId) && Mapper.isEqual(self.householdClientReferenceId, other.householdClientReferenceId) && Mapper.isEqual(self.individualId, other.individualId) && Mapper.isEqual(self.individualClientReferenceId, other.individualClientReferenceId) && Mapper.isEqual(self.isHeadOfHousehold, other.isHeadOfHousehold) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class _HouseholdMemberModelCopyWithImpl<$R> extends BaseCopyWith<HouseholdMemberModel, $R> implements HouseholdMemberModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? householdId = $none, Object? householdClientReferenceId = $none, Object? individualId = $none, Object? individualClientReferenceId = $none, bool? isHeadOfHousehold, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(HouseholdMemberModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), householdId: or(householdId, $value.householdId), householdClientReferenceId: or(householdClientReferenceId, $value.householdClientReferenceId), individualId: or(individualId, $value.individualId), individualClientReferenceId: or(individualClientReferenceId, $value.individualClientReferenceId), isHeadOfHousehold: isHeadOfHousehold ?? $value.isHeadOfHousehold, clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class IdentifierModelMapper extends BaseMapper<IdentifierModel> {
  ...
  Map<String, dynamic> toMap(IdentifierModel i) => {if (Mapper.i.$enc(i.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(i.additionalFields, 'additionalFields'), if (Mapper.i.$enc(i.id, 'id') != null) 'id': Mapper.i.$enc(i.id, 'id'), if (Mapper.i.$enc(i.identifierType, 'identifierType') != null) 'identifierType': Mapper.i.$enc(i.identifierType, 'identifierType'), if (Mapper.i.$enc(i.identifierId, 'identifierId') != null) 'identifierId': Mapper.i.$enc(i.identifierId, 'identifierId'), 'clientReferenceId': Mapper.i.$enc(i.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(i.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(i.tenantId, 'tenantId'), if (Mapper.i.$enc(i.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(i.rowVersion, 'rowVersion'), if (Mapper.i.$enc(i.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(i.auditDetails, 'auditDetails'), if (Mapper.i.$enc(i.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(i.isDeleted, 'isDeleted')};

  @override String stringify(IdentifierModel self) => 'IdentifierModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, identifierType: ${Mapper.asString(self.identifierType)}, identifierId: ${Mapper.asString(self.identifierId)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(IdentifierModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.identifierType) ^ Mapper.hash(self.identifierId) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(IdentifierModel self, IdentifierModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.identifierType, other.identifierType) && Mapper.isEqual(self.identifierId, other.identifierId) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class IdentifierModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({IdentifierAdditionalFields? additionalFields, String? id, String? identifierType, String? identifierId, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _IdentifierModelCopyWithImpl<$R> extends BaseCopyWith<IdentifierModel, $R> implements IdentifierModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? identifierType = $none, Object? identifierId = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(IdentifierModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), identifierType: or(identifierType, $value.identifierType), identifierId: or(identifierId, $value.identifierId), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class IndividualModelMapper extends BaseMapper<IndividualModel> {
  ...
  Map<String, dynamic> toMap(IndividualModel i) => {if (Mapper.i.$enc(i.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(i.additionalFields, 'additionalFields'), if (Mapper.i.$enc(i.id, 'id') != null) 'id': Mapper.i.$enc(i.id, 'id'), if (Mapper.i.$enc(i.userId, 'userId') != null) 'userId': Mapper.i.$enc(i.userId, 'userId'), if (Mapper.i.$enc(i.dateOfBirth, 'dateOfBirth') != null) 'dateOfBirth': Mapper.i.$enc(i.dateOfBirth, 'dateOfBirth'), if (Mapper.i.$enc(i.mobileNumber, 'mobileNumber') != null) 'mobileNumber': Mapper.i.$enc(i.mobileNumber, 'mobileNumber'), if (Mapper.i.$enc(i.altContactNumber, 'altContactNumber') != null) 'altContactNumber': Mapper.i.$enc(i.altContactNumber, 'altContactNumber'), if (Mapper.i.$enc(i.email, 'email') != null) 'email': Mapper.i.$enc(i.email, 'email'), if (Mapper.i.$enc(i.fatherName, 'fatherName') != null) 'fatherName': Mapper.i.$enc(i.fatherName, 'fatherName'), if (Mapper.i.$enc(i.husbandName, 'husbandName') != null) 'husbandName': Mapper.i.$enc(i.husbandName, 'husbandName'), if (Mapper.i.$enc(i.photo, 'photo') != null) 'photo': Mapper.i.$enc(i.photo, 'photo'), 'clientReferenceId': Mapper.i.$enc(i.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(i.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(i.tenantId, 'tenantId'), if (Mapper.i.$enc(i.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(i.rowVersion, 'rowVersion'), if (Mapper.i.$enc(i.name, 'name') != null) 'name': Mapper.i.$enc(i.name, 'name'), if (Mapper.i.$enc(i.bloodGroup, 'bloodGroup') != null) 'bloodGroup': Mapper.i.$enc(i.bloodGroup, 'bloodGroup'), if (Mapper.i.$enc(i.address, 'address') != null) 'address': Mapper.i.$enc(i.address, 'address'), if (Mapper.i.$enc(i.gender, 'gender') != null) 'gender': Mapper.i.$enc(i.gender, 'gender'), if (Mapper.i.$enc(i.identifiers, 'identifiers') != null) 'identifiers': Mapper.i.$enc(i.identifiers, 'identifiers'), if (Mapper.i.$enc(i.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(i.auditDetails, 'auditDetails'), if (Mapper.i.$enc(i.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(i.isDeleted, 'isDeleted')};

  @override String stringify(IndividualModel self) => 'IndividualModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, userId: ${Mapper.asString(self.userId)}, dateOfBirth: ${Mapper.asString(self.dateOfBirth)}, mobileNumber: ${Mapper.asString(self.mobileNumber)}, altContactNumber: ${Mapper.asString(self.altContactNumber)}, email: ${Mapper.asString(self.email)}, fatherName: ${Mapper.asString(self.fatherName)}, husbandName: ${Mapper.asString(self.husbandName)}, photo: ${Mapper.asString(self.photo)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, name: ${Mapper.asString(self.name)}, bloodGroup: ${Mapper.asString(self.bloodGroup)}, address: ${Mapper.asString(self.address)}, gender: ${Mapper.asString(self.gender)}, identifiers: ${Mapper.asString(self.identifiers)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(IndividualModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.userId) ^ Mapper.hash(self.dateOfBirth) ^ Mapper.hash(self.mobileNumber) ^ Mapper.hash(self.altContactNumber) ^ Mapper.hash(self.email) ^ Mapper.hash(self.fatherName) ^ Mapper.hash(self.husbandName) ^ Mapper.hash(self.photo) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.name) ^ Mapper.hash(self.bloodGroup) ^ Mapper.hash(self.address) ^ Mapper.hash(self.gender) ^ Mapper.hash(self.identifiers) ^ Mapper.hash(self.additionalFields);
  @override bool equals(IndividualModel self, IndividualModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.userId, other.userId) && Mapper.isEqual(self.dateOfBirth, other.dateOfBirth) && Mapper.isEqual(self.mobileNumber, other.mobileNumber) && Mapper.isEqual(self.altContactNumber, other.altContactNumber) && Mapper.isEqual(self.email, other.email) && Mapper.isEqual(self.fatherName, other.fatherName) && Mapper.isEqual(self.husbandName, other.husbandName) && Mapper.isEqual(self.photo, other.photo) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.bloodGroup, other.bloodGroup) && Mapper.isEqual(self.address, other.address) && Mapper.isEqual(self.gender, other.gender) && Mapper.isEqual(self.identifiers, other.identifiers) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class IndividualModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({IndividualAdditionalFields? additionalFields, String? id, String? userId, String? dateOfBirth, String? mobileNumber, String? altContactNumber, String? email, String? fatherName, String? husbandName, String? photo, String? clientReferenceId, String? tenantId, int? rowVersion, NameModel? name, BloodGroup? bloodGroup, List<AddressModel>? address, Gender? gender, List<IdentifierModel>? identifiers, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _IndividualModelCopyWithImpl<$R> extends BaseCopyWith<IndividualModel, $R> implements IndividualModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? userId = $none, Object? dateOfBirth = $none, Object? mobileNumber = $none, Object? altContactNumber = $none, Object? email = $none, Object? fatherName = $none, Object? husbandName = $none, Object? photo = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? name = $none, Object? bloodGroup = $none, Object? address = $none, Object? gender = $none, Object? identifiers = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(IndividualModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), userId: or(userId, $value.userId), dateOfBirth: or(dateOfBirth, $value.dateOfBirth), mobileNumber: or(mobileNumber, $value.mobileNumber), altContactNumber: or(altContactNumber, $value.altContactNumber), email: or(email, $value.email), fatherName: or(fatherName, $value.fatherName), husbandName: or(husbandName, $value.husbandName), photo: or(photo, $value.photo), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), name: or(name, $value.name), bloodGroup: or(bloodGroup, $value.bloodGroup), address: or(address, $value.address), gender: or(gender, $value.gender), identifiers: or(identifiers, $value.identifiers), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class LocalityModelMapper extends BaseMapper<LocalityModel> {
  ...
  LocalityModel fromMap(Map<String, dynamic> map) => LocalityModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), code: Mapper.i.$get(map, 'code'), name: Mapper.i.$getOpt(map, 'name'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (LocalityModel v) => encode(v);
  dynamic encode(LocalityModel v) => toMap(v);
  Map<String, dynamic> toMap(LocalityModel l) => {if (Mapper.i.$enc(l.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(l.additionalFields, 'additionalFields'), 'code': Mapper.i.$enc(l.code, 'code'), if (Mapper.i.$enc(l.name, 'name') != null) 'name': Mapper.i.$enc(l.name, 'name'), if (Mapper.i.$enc(l.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(l.tenantId, 'tenantId'), if (Mapper.i.$enc(l.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(l.rowVersion, 'rowVersion'), if (Mapper.i.$enc(l.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(l.auditDetails, 'auditDetails'), if (Mapper.i.$enc(l.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(l.isDeleted, 'isDeleted')};

  @override String stringify(LocalityModel self) => 'LocalityModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, code: ${Mapper.asString(self.code)}, name: ${Mapper.asString(self.name)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(LocalityModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.code) ^ Mapper.hash(self.name) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(LocalityModel self, LocalityModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class LocalityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({LocalityAdditionalFields? additionalFields, String? code, String? name, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _LocalityModelCopyWithImpl<$R> extends BaseCopyWith<LocalityModel, $R> implements LocalityModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? code, Object? name = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(LocalityModel(additionalFields: or(additionalFields, $value.additionalFields), code: code ?? $value.code, name: or(name, $value.name), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class NameModelMapper extends BaseMapper<NameModel> {
  ...
  NameModel fromMap(Map<String, dynamic> map) => NameModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), individualClientReferenceId: Mapper.i.$getOpt(map, 'individualClientReferenceId'), givenName: Mapper.i.$getOpt(map, 'givenName'), familyName: Mapper.i.$getOpt(map, 'familyName'), otherNames: Mapper.i.$getOpt(map, 'otherNames'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (NameModel v) => encode(v);
  dynamic encode(NameModel v) => toMap(v);
  Map<String, dynamic> toMap(NameModel n) => {if (Mapper.i.$enc(n.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(n.additionalFields, 'additionalFields'), if (Mapper.i.$enc(n.id, 'id') != null) 'id': Mapper.i.$enc(n.id, 'id'), if (Mapper.i.$enc(n.individualClientReferenceId, 'individualClientReferenceId') != null) 'individualClientReferenceId': Mapper.i.$enc(n.individualClientReferenceId, 'individualClientReferenceId'), if (Mapper.i.$enc(n.givenName, 'givenName') != null) 'givenName': Mapper.i.$enc(n.givenName, 'givenName'), if (Mapper.i.$enc(n.familyName, 'familyName') != null) 'familyName': Mapper.i.$enc(n.familyName, 'familyName'), if (Mapper.i.$enc(n.otherNames, 'otherNames') != null) 'otherNames': Mapper.i.$enc(n.otherNames, 'otherNames'), if (Mapper.i.$enc(n.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(n.tenantId, 'tenantId'), if (Mapper.i.$enc(n.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(n.rowVersion, 'rowVersion'), if (Mapper.i.$enc(n.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(n.auditDetails, 'auditDetails'), if (Mapper.i.$enc(n.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(n.isDeleted, 'isDeleted')};

  @override String stringify(NameModel self) => 'NameModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, individualClientReferenceId: ${Mapper.asString(self.individualClientReferenceId)}, givenName: ${Mapper.asString(self.givenName)}, familyName: ${Mapper.asString(self.familyName)}, otherNames: ${Mapper.asString(self.otherNames)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(NameModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.individualClientReferenceId) ^ Mapper.hash(self.givenName) ^ Mapper.hash(self.familyName) ^ Mapper.hash(self.otherNames) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(NameModel self, NameModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.individualClientReferenceId, other.individualClientReferenceId) && Mapper.isEqual(self.givenName, other.givenName) && Mapper.isEqual(self.familyName, other.familyName) && Mapper.isEqual(self.otherNames, other.otherNames) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class NameModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({NameAdditionalFields? additionalFields, String? id, String? individualClientReferenceId, String? givenName, String? familyName, String? otherNames, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _NameModelCopyWithImpl<$R> extends BaseCopyWith<NameModel, $R> implements NameModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? individualClientReferenceId = $none, Object? givenName = $none, Object? familyName = $none, Object? otherNames = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(NameModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), individualClientReferenceId: or(individualClientReferenceId, $value.individualClientReferenceId), givenName: or(givenName, $value.givenName), familyName: or(familyName, $value.familyName), otherNames: or(otherNames, $value.otherNames), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProductModelMapper extends BaseMapper<ProductModel> {
  ...
  Map<String, dynamic> toMap(ProductModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), if (Mapper.i.$enc(p.id, 'id') != null) 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.type, 'type') != null) 'type': Mapper.i.$enc(p.type, 'type'), if (Mapper.i.$enc(p.name, 'name') != null) 'name': Mapper.i.$enc(p.name, 'name'), if (Mapper.i.$enc(p.manufacturer, 'manufacturer') != null) 'manufacturer': Mapper.i.$enc(p.manufacturer, 'manufacturer'), 'clientReferenceId': Mapper.i.$enc(p.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProductModel self) => 'ProductModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, type: ${Mapper.asString(self.type)}, name: ${Mapper.asString(self.name)}, manufacturer: ${Mapper.asString(self.manufacturer)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProductModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.type) ^ Mapper.hash(self.name) ^ Mapper.hash(self.manufacturer) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProductModel self, ProductModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.type, other.type) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.manufacturer, other.manufacturer) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProductModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProductAdditionalFields? additionalFields, String? id, String? type, String? name, String? manufacturer, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _ProductModelCopyWithImpl<$R> extends BaseCopyWith<ProductModel, $R> implements ProductModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? type = $none, Object? name = $none, Object? manufacturer = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(ProductModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), type: or(type, $value.type), name: or(name, $value.name), manufacturer: or(manufacturer, $value.manufacturer), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProductVariantModelMapper extends BaseMapper<ProductVariantModel> {
  ...
  ProductVariantModel fromMap(Map<String, dynamic> map) => ProductVariantModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), productId: Mapper.i.$getOpt(map, 'productId'), sku: Mapper.i.$getOpt(map, 'sku'), variation: Mapper.i.$getOpt(map, 'variation'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (ProductVariantModel v) => encode(v);
  dynamic encode(ProductVariantModel v) => toMap(v);
  Map<String, dynamic> toMap(ProductVariantModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.productId, 'productId') != null) 'productId': Mapper.i.$enc(p.productId, 'productId'), if (Mapper.i.$enc(p.sku, 'sku') != null) 'sku': Mapper.i.$enc(p.sku, 'sku'), if (Mapper.i.$enc(p.variation, 'variation') != null) 'variation': Mapper.i.$enc(p.variation, 'variation'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProductVariantModel self) => 'ProductVariantModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, productId: ${Mapper.asString(self.productId)}, sku: ${Mapper.asString(self.sku)}, variation: ${Mapper.asString(self.variation)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProductVariantModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.productId) ^ Mapper.hash(self.sku) ^ Mapper.hash(self.variation) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProductVariantModel self, ProductVariantModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.productId, other.productId) && Mapper.isEqual(self.sku, other.sku) && Mapper.isEqual(self.variation, other.variation) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProductVariantModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProductVariantAdditionalFields? additionalFields, String? id, String? productId, String? sku, String? variation, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _ProductVariantModelCopyWithImpl<$R> extends BaseCopyWith<ProductVariantModel, $R> implements ProductVariantModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? id, Object? productId = $none, Object? sku = $none, Object? variation = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(ProductVariantModel(additionalFields: or(additionalFields, $value.additionalFields), id: id ?? $value.id, productId: or(productId, $value.productId), sku: or(sku, $value.sku), variation: or(variation, $value.variation), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class ProjectBeneficiarySearchModelCopyWith<$R> {
  ...
  $R call({String? id, String? projectId, String? beneficiaryId, String? beneficiaryClientReferenceId, DateTime? beneficiaryRegistrationDateLte, DateTime? beneficiaryRegistrationDateGte, List<String>? clientReferenceId, String? tenantId, int? dateOfRegistration, String? boundaryCode});
...
class ProjectBeneficiaryModelMapper extends BaseMapper<ProjectBeneficiaryModel> {
  ...
  Map<String, dynamic> toMap(ProjectBeneficiaryModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), if (Mapper.i.$enc(p.id, 'id') != null) 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.projectId, 'projectId') != null) 'projectId': Mapper.i.$enc(p.projectId, 'projectId'), if (Mapper.i.$enc(p.beneficiaryId, 'beneficiaryId') != null) 'beneficiaryId': Mapper.i.$enc(p.beneficiaryId, 'beneficiaryId'), if (Mapper.i.$enc(p.beneficiaryClientReferenceId, 'beneficiaryClientReferenceId') != null) 'beneficiaryClientReferenceId': Mapper.i.$enc(p.beneficiaryClientReferenceId, 'beneficiaryClientReferenceId'), 'clientReferenceId': Mapper.i.$enc(p.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), 'dateOfRegistration': Mapper.i.$enc(p.dateOfRegistration, 'dateOfRegistration'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProjectBeneficiaryModel self) => 'ProjectBeneficiaryModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, projectId: ${Mapper.asString(self.projectId)}, beneficiaryId: ${Mapper.asString(self.beneficiaryId)}, beneficiaryClientReferenceId: ${Mapper.asString(self.beneficiaryClientReferenceId)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, dateOfRegistrationTime: ${Mapper.asString(self.dateOfRegistrationTime)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectBeneficiaryModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.beneficiaryId) ^ Mapper.hash(self.beneficiaryClientReferenceId) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.dateOfRegistrationTime) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectBeneficiaryModel self, ProjectBeneficiaryModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.beneficiaryId, other.beneficiaryId) && Mapper.isEqual(self.beneficiaryClientReferenceId, other.beneficiaryClientReferenceId) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.dateOfRegistrationTime, other.dateOfRegistrationTime) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProjectBeneficiaryModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectBeneficiaryAdditionalFields? additionalFields, String? id, String? projectId, String? beneficiaryId, String? beneficiaryClientReferenceId, String? clientReferenceId, String? tenantId, int? rowVersion, int? dateOfRegistration, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _ProjectBeneficiaryModelCopyWithImpl<$R> extends BaseCopyWith<ProjectBeneficiaryModel, $R> implements ProjectBeneficiaryModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? projectId = $none, Object? beneficiaryId = $none, Object? beneficiaryClientReferenceId = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, int? dateOfRegistration, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(ProjectBeneficiaryModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), projectId: or(projectId, $value.projectId), beneficiaryId: or(beneficiaryId, $value.beneficiaryId), beneficiaryClientReferenceId: or(beneficiaryClientReferenceId, $value.beneficiaryClientReferenceId), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), dateOfRegistration: dateOfRegistration ?? $value.dateOfRegistration, auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProjectFacilityModelMapper extends BaseMapper<ProjectFacilityModel> {
  ...
  ProjectFacilityModel fromMap(Map<String, dynamic> map) => ProjectFacilityModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), facilityId: Mapper.i.$get(map, 'facilityId'), projectId: Mapper.i.$get(map, 'projectId'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (ProjectFacilityModel v) => encode(v);
  dynamic encode(ProjectFacilityModel v) => toMap(v);
  Map<String, dynamic> toMap(ProjectFacilityModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), 'id': Mapper.i.$enc(p.id, 'id'), 'facilityId': Mapper.i.$enc(p.facilityId, 'facilityId'), 'projectId': Mapper.i.$enc(p.projectId, 'projectId'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProjectFacilityModel self) => 'ProjectFacilityModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, facilityId: ${Mapper.asString(self.facilityId)}, projectId: ${Mapper.asString(self.projectId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectFacilityModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.facilityId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectFacilityModel self, ProjectFacilityModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.facilityId, other.facilityId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProjectFacilityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectFacilityAdditionalFields? additionalFields, String? id, String? facilityId, String? projectId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _ProjectFacilityModelCopyWithImpl<$R> extends BaseCopyWith<ProjectFacilityModel, $R> implements ProjectFacilityModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? id, String? facilityId, String? projectId, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(ProjectFacilityModel(additionalFields: or(additionalFields, $value.additionalFields), id: id ?? $value.id, facilityId: facilityId ?? $value.facilityId, projectId: projectId ?? $value.projectId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProjectProductVariantModelMapper extends BaseMapper<ProjectProductVariantModel> {
  ...
  ProjectProductVariantModel fromMap(Map<String, dynamic> map) => ProjectProductVariantModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), productVariantId: Mapper.i.$get(map, 'productVariantId'), type: Mapper.i.$getOpt(map, 'type'), isBaseUnitVariant: Mapper.i.$getOpt(map, 'isBaseUnitVariant'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (ProjectProductVariantModel v) => encode(v);
  dynamic encode(ProjectProductVariantModel v) => toMap(v);
  Map<String, dynamic> toMap(ProjectProductVariantModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), 'productVariantId': Mapper.i.$enc(p.productVariantId, 'productVariantId'), if (Mapper.i.$enc(p.type, 'type') != null) 'type': Mapper.i.$enc(p.type, 'type'), if (Mapper.i.$enc(p.isBaseUnitVariant, 'isBaseUnitVariant') != null) 'isBaseUnitVariant': Mapper.i.$enc(p.isBaseUnitVariant, 'isBaseUnitVariant'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProjectProductVariantModel self) => 'ProjectProductVariantModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, productVariantId: ${Mapper.asString(self.productVariantId)}, type: ${Mapper.asString(self.type)}, isBaseUnitVariant: ${Mapper.asString(self.isBaseUnitVariant)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectProductVariantModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.productVariantId) ^ Mapper.hash(self.type) ^ Mapper.hash(self.isBaseUnitVariant) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectProductVariantModel self, ProjectProductVariantModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.productVariantId, other.productVariantId) && Mapper.isEqual(self.type, other.type) && Mapper.isEqual(self.isBaseUnitVariant, other.isBaseUnitVariant) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProjectProductVariantModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectProductVariantAdditionalFields? additionalFields, String? productVariantId, String? type, bool? isBaseUnitVariant, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _ProjectProductVariantModelCopyWithImpl<$R> extends BaseCopyWith<ProjectProductVariantModel, $R> implements ProjectProductVariantModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? productVariantId, Object? type = $none, Object? isBaseUnitVariant = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(ProjectProductVariantModel(additionalFields: or(additionalFields, $value.additionalFields), productVariantId: productVariantId ?? $value.productVariantId, type: or(type, $value.type), isBaseUnitVariant: or(isBaseUnitVariant, $value.isBaseUnitVariant), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProjectResourceModelMapper extends BaseMapper<ProjectResourceModel> {
  ...
  ProjectResourceModel fromMap(Map<String, dynamic> map) => ProjectResourceModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), projectId: Mapper.i.$getOpt(map, 'projectId'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), resource: Mapper.i.$get(map, 'resource'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (ProjectResourceModel v) => encode(v);
  dynamic encode(ProjectResourceModel v) => toMap(v);
  Map<String, dynamic> toMap(ProjectResourceModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), if (Mapper.i.$enc(p.id, 'id') != null) 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.projectId, 'projectId') != null) 'projectId': Mapper.i.$enc(p.projectId, 'projectId'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), 'resource': Mapper.i.$enc(p.resource, 'resource'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProjectResourceModel self) => 'ProjectResourceModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, projectId: ${Mapper.asString(self.projectId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, resource: ${Mapper.asString(self.resource)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectResourceModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.resource) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectResourceModel self, ProjectResourceModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.resource, other.resource) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProjectResourceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectResourceAdditionalFields? additionalFields, String? id, String? projectId, String? tenantId, int? rowVersion, ProjectProductVariantModel? resource, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _ProjectResourceModelCopyWithImpl<$R> extends BaseCopyWith<ProjectResourceModel, $R> implements ProjectResourceModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? projectId = $none, Object? tenantId = $none, Object? rowVersion = $none, ProjectProductVariantModel? resource, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(ProjectResourceModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), projectId: or(projectId, $value.projectId), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), resource: resource ?? $value.resource, auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class ProjectStaffModelMapper extends BaseMapper<ProjectStaffModel> {
  ...
  ProjectStaffModel fromMap(Map<String, dynamic> map) => ProjectStaffModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), staffId: Mapper.i.$getOpt(map, 'staffId'), userId: Mapper.i.$getOpt(map, 'userId'), projectId: Mapper.i.$getOpt(map, 'projectId'), channel: Mapper.i.$getOpt(map, 'channel'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), startDate: Mapper.i.$getOpt(map, 'startDate'), endDate: Mapper.i.$getOpt(map, 'endDate'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (ProjectStaffModel v) => encode(v);
  dynamic encode(ProjectStaffModel v) => toMap(v);
  Map<String, dynamic> toMap(ProjectStaffModel p) => {if (Mapper.i.$enc(p.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(p.additionalFields, 'additionalFields'), 'id': Mapper.i.$enc(p.id, 'id'), if (Mapper.i.$enc(p.staffId, 'staffId') != null) 'staffId': Mapper.i.$enc(p.staffId, 'staffId'), if (Mapper.i.$enc(p.userId, 'userId') != null) 'userId': Mapper.i.$enc(p.userId, 'userId'), if (Mapper.i.$enc(p.projectId, 'projectId') != null) 'projectId': Mapper.i.$enc(p.projectId, 'projectId'), if (Mapper.i.$enc(p.channel, 'channel') != null) 'channel': Mapper.i.$enc(p.channel, 'channel'), if (Mapper.i.$enc(p.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(p.tenantId, 'tenantId'), if (Mapper.i.$enc(p.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(p.rowVersion, 'rowVersion'), if (Mapper.i.$enc(p.startDate, 'startDate') != null) 'startDate': Mapper.i.$enc(p.startDate, 'startDate'), if (Mapper.i.$enc(p.endDate, 'endDate') != null) 'endDate': Mapper.i.$enc(p.endDate, 'endDate'), if (Mapper.i.$enc(p.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(p.auditDetails, 'auditDetails'), if (Mapper.i.$enc(p.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(p.isDeleted, 'isDeleted')};

  @override String stringify(ProjectStaffModel self) => 'ProjectStaffModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, staffId: ${Mapper.asString(self.staffId)}, userId: ${Mapper.asString(self.userId)}, projectId: ${Mapper.asString(self.projectId)}, channel: ${Mapper.asString(self.channel)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, startDateTime: ${Mapper.asString(self.startDateTime)}, endDateTime: ${Mapper.asString(self.endDateTime)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectStaffModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.staffId) ^ Mapper.hash(self.userId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.channel) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.startDateTime) ^ Mapper.hash(self.endDateTime) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectStaffModel self, ProjectStaffModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.staffId, other.staffId) && Mapper.isEqual(self.userId, other.userId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.channel, other.channel) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.startDateTime, other.startDateTime) && Mapper.isEqual(self.endDateTime, other.endDateTime) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ProjectStaffModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectStaffAdditionalFields? additionalFields, String? id, String? staffId, String? userId, String? projectId, String? channel, String? tenantId, int? rowVersion, int? startDate, int? endDate, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
abstract class ProjectTypeModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ProjectTypeAdditionalFields? additionalFields, String? id, String? name, String? code, String? group, String? beneficiaryType, List<String>? eligibilityCriteria, List<String>? taskProcedure, String? clientReferenceId, String? tenantId, int? rowVersion, List<ProjectProductVariantModel>? resources, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
abstract class ServiceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ServiceAdditionalFields? additionalFields, String? id, String? clientId, String? serviceDefId, bool? isActive, String? accountId, String? additionalDetails, String? createdAt, String? tenantId, int? rowVersion, List<ServiceAttributesModel>? attributes, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class ServiceAttributesModelMapper extends BaseMapper<ServiceAttributesModel> {
  ...
  Map<String, dynamic> toMap(ServiceAttributesModel s) => {if (Mapper.i.$enc(s.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(s.additionalFields, 'additionalFields'), if (Mapper.i.$enc(s.attributeCode, 'attributeCode') != null) 'attributeCode': Mapper.i.$enc(s.attributeCode, 'attributeCode'), 'value': Mapper.i.$enc(s.value, 'value'), if (Mapper.i.$enc(s.dataType, 'dataType') != null) 'dataType': Mapper.i.$enc(s.dataType, 'dataType'), if (Mapper.i.$enc(s.referenceId, 'referenceId') != null) 'referenceId': Mapper.i.$enc(s.referenceId, 'referenceId'), 'additionalDetails': Mapper.i.$enc(s.additionalDetails, 'additionalDetails'), 'clientReferenceId': Mapper.i.$enc(s.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(s.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(s.tenantId, 'tenantId'), if (Mapper.i.$enc(s.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(s.rowVersion, 'rowVersion'), if (Mapper.i.$enc(s.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(s.auditDetails, 'auditDetails'), if (Mapper.i.$enc(s.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(s.isDeleted, 'isDeleted')};

  @override String stringify(ServiceAttributesModel self) => 'ServiceAttributesModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, attributeCode: ${Mapper.asString(self.attributeCode)}, value: ${Mapper.asString(self.value)}, dataType: ${Mapper.asString(self.dataType)}, referenceId: ${Mapper.asString(self.referenceId)}, additionalDetails: ${Mapper.asString(self.additionalDetails)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ServiceAttributesModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.attributeCode) ^ Mapper.hash(self.value) ^ Mapper.hash(self.dataType) ^ Mapper.hash(self.referenceId) ^ Mapper.hash(self.additionalDetails) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ServiceAttributesModel self, ServiceAttributesModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.attributeCode, other.attributeCode) && Mapper.isEqual(self.value, other.value) && Mapper.isEqual(self.dataType, other.dataType) && Mapper.isEqual(self.referenceId, other.referenceId) && Mapper.isEqual(self.additionalDetails, other.additionalDetails) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ServiceAttributesModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ServiceAttributesAdditionalFields? additionalFields, String? attributeCode, dynamic value, String? dataType, String? referenceId, dynamic additionalDetails, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class ServiceDefinitionModelMapper extends BaseMapper<ServiceDefinitionModel> {
  ...
  ServiceDefinitionModel fromMap(Map<String, dynamic> map) => ServiceDefinitionModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), code: Mapper.i.$getOpt(map, 'code'), isActive: Mapper.i.$getOpt(map, 'isActive'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), attributes: Mapper.i.$getOpt(map, 'attributes'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);

  @override Function get encoder => (ServiceDefinitionModel v) => encode(v);
  dynamic encode(ServiceDefinitionModel v) => toMap(v);
  Map<String, dynamic> toMap(ServiceDefinitionModel s) => {if (Mapper.i.$enc(s.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(s.additionalFields, 'additionalFields'), if (Mapper.i.$enc(s.id, 'id') != null) 'id': Mapper.i.$enc(s.id, 'id'), if (Mapper.i.$enc(s.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(s.tenantId, 'tenantId'), if (Mapper.i.$enc(s.code, 'code') != null) 'code': Mapper.i.$enc(s.code, 'code'), if (Mapper.i.$enc(s.isActive, 'isActive') != null) 'isActive': Mapper.i.$enc(s.isActive, 'isActive'), if (Mapper.i.$enc(s.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(s.rowVersion, 'rowVersion'), if (Mapper.i.$enc(s.attributes, 'attributes') != null) 'attributes': Mapper.i.$enc(s.attributes, 'attributes'), if (Mapper.i.$enc(s.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(s.auditDetails, 'auditDetails'), if (Mapper.i.$enc(s.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(s.isDeleted, 'isDeleted')};

  @override String stringify(ServiceDefinitionModel self) => 'ServiceDefinitionModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, tenantId: ${Mapper.asString(self.tenantId)}, code: ${Mapper.asString(self.code)}, isActive: ${Mapper.asString(self.isActive)}, rowVersion: ${Mapper.asString(self.rowVersion)}, attributes: ${Mapper.asString(self.attributes)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ServiceDefinitionModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.attributes) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ServiceDefinitionModel self, ServiceDefinitionModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.attributes, other.attributes) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class ServiceDefinitionModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({ServiceDefinitionAdditionalFields? additionalFields, String? id, String? tenantId, String? code, bool? isActive, int? rowVersion, List<AttributesModel>? attributes, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _ServiceDefinitionModelCopyWithImpl<$R> extends BaseCopyWith<ServiceDefinitionModel, $R> implements ServiceDefinitionModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? tenantId = $none, Object? code = $none, Object? isActive = $none, Object? rowVersion = $none, Object? attributes = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(ServiceDefinitionModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), tenantId: or(tenantId, $value.tenantId), code: or(code, $value.code), isActive: or(isActive, $value.isActive), rowVersion: or(rowVersion, $value.rowVersion), attributes: or(attributes, $value.attributes), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class StockModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({StockAdditionalFields? additionalFields, String? id, String? tenantId, String? facilityId, String? productVariantId, String? referenceId, String? referenceIdType, String? transactingPartyId, String? transactingPartyType, String? quantity, String? waybillNumber, String? clientReferenceId, int? rowVersion, TransactionType? transactionType, TransactionReason? transactionReason, int? dateOfEntry, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _StockModelCopyWithImpl<$R> extends BaseCopyWith<StockModel, $R> implements StockModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? tenantId = $none, Object? facilityId = $none, Object? productVariantId = $none, Object? referenceId = $none, Object? referenceIdType = $none, Object? transactingPartyId = $none, Object? transactingPartyType = $none, Object? quantity = $none, Object? waybillNumber = $none, String? clientReferenceId, Object? rowVersion = $none, Object? transactionType = $none, Object? transactionReason = $none, Object? dateOfEntry = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(StockModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), tenantId: or(tenantId, $value.tenantId), facilityId: or(facilityId, $value.facilityId), productVariantId: or(productVariantId, $value.productVariantId), referenceId: or(referenceId, $value.referenceId), referenceIdType: or(referenceIdType, $value.referenceIdType), transactingPartyId: or(transactingPartyId, $value.transactingPartyId), transactingPartyType: or(transactingPartyType, $value.transactingPartyType), quantity: or(quantity, $value.quantity), waybillNumber: or(waybillNumber, $value.waybillNumber), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, rowVersion: or(rowVersion, $value.rowVersion), transactionType: or(transactionType, $value.transactionType), transactionReason: or(transactionReason, $value.transactionReason), dateOfEntry: or(dateOfEntry, $value.dateOfEntry), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class TargetModelMapper extends BaseMapper<TargetModel> {
  ...
  TargetModel fromMap(Map<String, dynamic> map) => TargetModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), clientReferenceId: Mapper.i.$getOpt(map, 'clientReferenceId'), totalNo: Mapper.i.$getOpt(map, 'totalNo'), targetNo: Mapper.i.$getOpt(map, 'targetNo'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), beneficiaryType: Mapper.i.$getOpt(map, 'beneficiaryType'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'), clientAuditDetails: Mapper.i.$getOpt(map, 'clientAuditDetails'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted') ?? false);
...
abstract class TargetModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({TargetAdditionalFields? additionalFields, String? id, String? clientReferenceId, double? totalNo, double? targetNo, String? tenantId, int? rowVersion, BeneficiaryType? beneficiaryType, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _TargetModelCopyWithImpl<$R> extends BaseCopyWith<TargetModel, $R> implements TargetModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? id, Object? clientReferenceId = $none, Object? totalNo = $none, Object? targetNo = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? beneficiaryType = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(TargetModel(additionalFields: or(additionalFields, $value.additionalFields), id: id ?? $value.id, clientReferenceId: or(clientReferenceId, $value.clientReferenceId), totalNo: or(totalNo, $value.totalNo), targetNo: or(targetNo, $value.targetNo), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), beneficiaryType: or(beneficiaryType, $value.beneficiaryType), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
abstract class TaskSearchModelCopyWith<$R> {
  ...
  $R call({String? id, String? projectId, String? projectBeneficiaryId, String? projectBeneficiaryClientReferenceId, String? createdBy, String? status, List<String>? clientReferenceId, String? tenantId, int? plannedStartDate, int? plannedEndDate, int? actualStartDate, int? actualEndDate, String? boundaryCode});
...
abstract class TaskModelCopyWith<$R> {
  ...
  AddressModelCopyWith<$R>? get address;
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({TaskAdditionalFields? additionalFields, String? id, String? projectId, String? projectBeneficiaryId, String? projectBeneficiaryClientReferenceId, String? createdBy, String? status, String? clientReferenceId, String? tenantId, int? rowVersion, List<TaskResourceModel>? resources, AddressModel? address, int? plannedStartDate, int? plannedEndDate, int? actualStartDate, int? actualEndDate, int? createdDate, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _TaskModelCopyWithImpl<$R> extends BaseCopyWith<TaskModel, $R> implements TaskModelCopyWith<$R> {
  ...
  @override AddressModelCopyWith<$R>? get address => $value.address != null ? AddressModelCopyWith($value.address!, (v) => call(address: v)) : null;
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? projectId = $none, Object? projectBeneficiaryId = $none, Object? projectBeneficiaryClientReferenceId = $none, Object? createdBy = $none, Object? status = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? resources = $none, Object? address = $none, Object? plannedStartDate = $none, Object? plannedEndDate = $none, Object? actualStartDate = $none, Object? actualEndDate = $none, Object? createdDate = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(TaskModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), projectId: or(projectId, $value.projectId), projectBeneficiaryId: or(projectBeneficiaryId, $value.projectBeneficiaryId), projectBeneficiaryClientReferenceId: or(projectBeneficiaryClientReferenceId, $value.projectBeneficiaryClientReferenceId), createdBy: or(createdBy, $value.createdBy), status: or(status, $value.status), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), resources: or(resources, $value.resources), address: or(address, $value.address), plannedStartDate: or(plannedStartDate, $value.plannedStartDate), plannedEndDate: or(plannedEndDate, $value.plannedEndDate), actualStartDate: or(actualStartDate, $value.actualStartDate), actualEndDate: or(actualEndDate, $value.actualEndDate), createdDate: or(createdDate, $value.createdDate), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class TaskResourceModelMapper extends BaseMapper<TaskResourceModel> {
  ...
  Map<String, dynamic> toMap(TaskResourceModel t) => {if (Mapper.i.$enc(t.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(t.additionalFields, 'additionalFields'), 'clientReferenceId': Mapper.i.$enc(t.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(t.taskId, 'taskId') != null) 'taskId': Mapper.i.$enc(t.taskId, 'taskId'), if (Mapper.i.$enc(t.id, 'id') != null) 'id': Mapper.i.$enc(t.id, 'id'), if (Mapper.i.$enc(t.productVariantId, 'productVariantId') != null) 'productVariantId': Mapper.i.$enc(t.productVariantId, 'productVariantId'), if (Mapper.i.$enc(t.quantity, 'quantity') != null) 'quantity': Mapper.i.$enc(t.quantity, 'quantity'), if (Mapper.i.$enc(t.isDelivered, 'isDelivered') != null) 'isDelivered': Mapper.i.$enc(t.isDelivered, 'isDelivered'), if (Mapper.i.$enc(t.deliveryComment, 'deliveryComment') != null) 'deliveryComment': Mapper.i.$enc(t.deliveryComment, 'deliveryComment'), if (Mapper.i.$enc(t.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(t.tenantId, 'tenantId'), if (Mapper.i.$enc(t.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(t.rowVersion, 'rowVersion'), if (Mapper.i.$enc(t.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(t.auditDetails, 'auditDetails'), if (Mapper.i.$enc(t.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(t.isDeleted, 'isDeleted')};

  @override String stringify(TaskResourceModel self) => 'TaskResourceModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, taskId: ${Mapper.asString(self.taskId)}, id: ${Mapper.asString(self.id)}, productVariantId: ${Mapper.asString(self.productVariantId)}, quantity: ${Mapper.asString(self.quantity)}, isDelivered: ${Mapper.asString(self.isDelivered)}, deliveryComment: ${Mapper.asString(self.deliveryComment)}, tenantId: ${Mapper.asString(self.tenantId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(TaskResourceModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.taskId) ^ Mapper.hash(self.id) ^ Mapper.hash(self.productVariantId) ^ Mapper.hash(self.quantity) ^ Mapper.hash(self.isDelivered) ^ Mapper.hash(self.deliveryComment) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(TaskResourceModel self, TaskResourceModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.taskId, other.taskId) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.productVariantId, other.productVariantId) && Mapper.isEqual(self.quantity, other.quantity) && Mapper.isEqual(self.isDelivered, other.isDelivered) && Mapper.isEqual(self.deliveryComment, other.deliveryComment) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class TaskResourceModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({TaskResourceAdditionalFields? additionalFields, String? clientReferenceId, String? taskId, String? id, String? productVariantId, String? quantity, bool? isDelivered, String? deliveryComment, String? tenantId, int? rowVersion, AuditDetails? auditDetails, required dynamic clientAuditDetails, bool? isDeleted});
...
class _TaskResourceModelCopyWithImpl<$R> extends BaseCopyWith<TaskResourceModel, $R> implements TaskResourceModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? clientReferenceId, Object? taskId = $none, Object? id = $none, Object? productVariantId = $none, Object? quantity = $none, Object? isDelivered = $none, Object? deliveryComment = $none, Object? tenantId = $none, Object? rowVersion = $none, Object? auditDetails = $none, required dynamic clientAuditDetails, Object? isDeleted = $none}) => $then(TaskResourceModel(additionalFields: or(additionalFields, $value.additionalFields), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, taskId: or(taskId, $value.taskId), id: or(id, $value.id), productVariantId: or(productVariantId, $value.productVariantId), quantity: or(quantity, $value.quantity), isDelivered: or(isDelivered, $value.isDelivered), deliveryComment: or(deliveryComment, $value.deliveryComment), tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), auditDetails: or(auditDetails, $value.auditDetails), clientAuditDetails: clientAuditDetails, isDeleted: or(isDeleted, $value.isDeleted)));
}
...
class PgrComplaintModelMapper extends BaseMapper<PgrComplaintModel> {
  ...
  @override String stringify(PgrComplaintModel self) => 'PgrComplaintModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, service: ${Mapper.asString(self.service)}, workflow: ${Mapper.asString(self.workflow)})';
  @override int hash(PgrComplaintModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.service) ^ Mapper.hash(self.workflow);
  @override bool equals(PgrComplaintModel self, PgrComplaintModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.service, other.service) && Mapper.isEqual(self.workflow, other.workflow);
...
class PgrRolesModelMapper extends BaseMapper<PgrRolesModel> {
  ...
  @override String stringify(PgrRolesModel self) => 'PgrRolesModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, name: ${Mapper.asString(self.name)}, code: ${Mapper.asString(self.code)})';
  @override int hash(PgrRolesModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.name) ^ Mapper.hash(self.code);
  @override bool equals(PgrRolesModel self, PgrRolesModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.code, other.code);
...
class PgrWorkflowModelMapper extends BaseMapper<PgrWorkflowModel> {
  ...
  @override String stringify(PgrWorkflowModel self) => 'PgrWorkflowModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, action: ${Mapper.asString(self.action)}, assignees: ${Mapper.asString(self.assignees)}, comments: ${Mapper.asString(self.comments)})';
  @override int hash(PgrWorkflowModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.action) ^ Mapper.hash(self.assignees) ^ Mapper.hash(self.comments);
  @override bool equals(PgrWorkflowModel self, PgrWorkflowModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.action, other.action) && Mapper.isEqual(self.assignees, other.assignees) && Mapper.isEqual(self.comments, other.comments);
...
class PgrServiceCreateResponseModelMapper extends BaseMapper<PgrServiceCreateResponseModel> {
  ...
  @override String stringify(PgrServiceCreateResponseModel self) => 'PgrServiceCreateResponseModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, serviceWrappers: ${Mapper.asString(self.serviceWrappers)})';
  @override int hash(PgrServiceCreateResponseModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.serviceWrappers);
  @override bool equals(PgrServiceCreateResponseModel self, PgrServiceCreateResponseModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.serviceWrappers, other.serviceWrappers);
...
class PgrComplaintResponseModelMapper extends BaseMapper<PgrComplaintResponseModel> {
  ...
  @override String stringify(PgrComplaintResponseModel self) => 'PgrComplaintResponseModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, service: ${Mapper.asString(self.service)}, workflow: ${Mapper.asString(self.workflow)})';
  @override int hash(PgrComplaintResponseModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.service) ^ Mapper.hash(self.workflow);
