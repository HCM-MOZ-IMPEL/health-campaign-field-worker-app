...
class _$HouseholdMemberWrapperCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    Object? members = null,
    Object? projectBeneficiary = null,
    Object? task = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      projectBeneficiary: null == projectBeneficiary
...
class _$_HouseholdMemberWrapper implements _HouseholdMemberWrapper {
  ...
  @override
  String toString() {
    return 'HouseholdMemberWrapper(household: $household, headOfHousehold: $headOfHousehold, members: $members, projectBeneficiary: $projectBeneficiary, task: $task)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, household, headOfHousehold,
      const DeepCollectionEquality().hash(_members), projectBeneficiary, task);
...
abstract class _HouseholdMemberWrapper implements HouseholdMemberWrapper {
  const factory _HouseholdMemberWrapper(
      ...
      required final List<IndividualModel> members,
      required final ProjectBeneficiaryModel projectBeneficiary,
      final TaskModel? task}) = _$_HouseholdMemberWrapper;
